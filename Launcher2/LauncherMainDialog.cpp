...
///////////////////////////////////////////////////////////////////////////////
            ...
            tabsInitialized(false)
        {
            ...
            dialogData  = new DialogData(IDD_MAINWINDOW,
                                         parent_window.getWindowHandle(), DialogData::ATTACH_ALL, handler);
            handler->dialogData = dialogData;
            tabs            = new DialogData(IDC_MAINTABS, GetDlgItem(
                                                 parent_window.getWindowHandle(),
                                                 IDD_MAINWINDOW),  DialogData::ATTACH_ALL, handler);
