    ...
    namespace launcher
    {
        ...
        void SoundsDialogHandler::initDialog()
        {
            ...
            addComboItems( GetDlgItem(hwnd,
                                      IDC_SCOMBO1), manager.getOptionNames("SpeakerType"),
                           manager.getTheOneInUse("SpeakerType") );
            addComboItems( GetDlgItem(hwnd,
                                      IDC_SCOMBO2), manager.getOptionNames("MixingRate"),
                           manager.getTheOneInUse("MixingRate") );
