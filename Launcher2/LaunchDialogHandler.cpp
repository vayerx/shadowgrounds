...
namespace frozenbyte
{
    namespace launcher
    {
        ...
        void LaunchDialogHandler::initDialog()
        {
            ...
            addComboItems( GetDlgItem(dialogHwnd, IDC_LANGCOMBO), manager.getOptionNames(
                               "Language"), manager.getTheOneInUse("Language") );
            addComboItems( GetDlgItem(dialogHwnd, IDC_OVERALLCOMBO), manager.getOptionNames(
                               "Overall Settings"), manager.getTheOneInUse("Overall Settings") );
            addComboItems( GetDlgItem(dialogHwnd, IDC_RESOLUTIONCOMBO), manager.getOptionNames(
