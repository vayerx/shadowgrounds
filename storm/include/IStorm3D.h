...
public:
    ...
    // Texture handling
    virtual IStorm3D_Texture *CreateNewTexture(const char *filename,
                                               uint32_t    tex_load_flags = 0,
                                               uint32_t    tex_identity = 0,
                                               const void *data = 0,
                                               size_t      data_size = 0) = 0;                                // Use tex_identity if you do not want to share this texture resource. (reasonable for videotextures only)
    ...
    virtual IStorm3D_VideoStreamer *CreateVideoStreamer(const char             *file_name,
    ...
    static IStorm3D *Create_Storm3D_Interface(bool                                        no_info = false,
                                              frozenbyte::filesystem::FilePackageManager *fileManager = 0,
                                              IStorm3D_Logger                            *logger = 0);
