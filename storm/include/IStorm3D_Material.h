...
public:
    ...
    virtual void SetBaseTexture2(IStorm3D_Texture *texture, MTL_BOP blend_op = MTL_BOP_MUL, float blend_factor =
                                     0.5f) = 0;
    virtual void SetBumpTexture(IStorm3D_Texture *texture, float bumpheight = 1.0f) = 0;
    virtual void SetReflectionTexture(IStorm3D_Texture *texture,
                                      TEX_GEN           texgen = TEX_GEN_REFLECTION,
                                      MTL_BOP           blend_op = MTL_BOP_ADD,
                                      float             blend_factor = 0.5f) = 0;
    ...
    virtual void ChangeReflectionTextureParameters(MTL_BOP op = MTL_BOP_ADD,
                                                   float   blend_factor = 0.5f,
                                                   TEX_GEN texgen = TEX_GEN_REFLECTION) = 0;
