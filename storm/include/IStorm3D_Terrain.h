...
public:
    ...
    // Maps
    virtual void setHeightMap(const unsigned short *buffer,
                              const VC2I           &resolution,
                              const VC3            &size,
                              int                   textureDetail,
                              unsigned short       *forceMap,
                              int                   heightmapMultiplier,
                              int                   obstaclemapMultiplier) = 0;
    ...
    // Terrain objects
    virtual int addModel(boost::shared_ptr<IStorm3D_Model> model,
                         boost::shared_ptr<IStorm3D_Model> fadeModel,
                         const std::string                &bones,
                         const std::string                &idleAnimation) = 0;
    ...
    virtual void rayTrace(const VC3             &position,
                          ...
                          bool                   accurate = false,
                          bool                   lineOfSight = false) const = 0;
};
