...
public:
    ...
    virtual void renderPoints(IStorm3D_Material *mtl, Storm3D_PointParticle *parts, int nParts, const COL &factor = COL(
                                  ), bool distortion = false) = 0;
    virtual void renderQuads(IStorm3D_Material *mtl, Storm3D_PointParticle *parts, int nParts,
                             Storm3D_ParticleTextureAnimationInfo *info = NULL,
                             const COL &factor = COL(), bool distortion = false, bool faceUp = false) = 0;
    virtual void renderLines(IStorm3D_Material *mtl, Storm3D_LineParticle *parts, int nParts,
                             Storm3D_ParticleTextureAnimationInfo *info = NULL,
                             const COL &factor = COL(), bool distortion = false) = 0;
