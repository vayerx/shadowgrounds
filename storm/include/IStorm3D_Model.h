...
public:
    ...
    virtual IStorm3D_Helper_Camera *Helper_Camera_New(const char *name,
                                                      const VC3  &position,
                                                      const VC3  &direction,
                                                      const VC3  &up) = 0;
    ...
    virtual bool BlendToAnimation(IStorm3D_BoneAnimation *transition,
                                  IStorm3D_BoneAnimation *animation,
                                  int                     blend_time,
                                  bool                    loop = true) = 0;
    // Blending with animations
    virtual bool BlendWithAnimationIn(IStorm3D_BoneAnimation *transition,
                                      IStorm3D_BoneAnimation *animation,
                                      int                     blend_in_time,
                                      bool                    loop = true,
                                      float                   blend_factor = 1.f) = 0;
    virtual bool BlendWithAnimationOut(IStorm3D_BoneAnimation *transition,
                                       IStorm3D_BoneAnimation *animation,
                                       int                     blend_out_time) = 0;
    // Manual blending
