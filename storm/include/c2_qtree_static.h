...
template <class T> struct StaticQuadtreeNode;
template <class T> class StaticQuadtree;
template <class T> class StaticQuadtreeRaytraceCollision;
template <class T> class StaticQuadtreeSphereCollision;
...
template <class T> class StaticQuadtreeRaytraceCollision {
    ...
    StaticQuadtreeRaytraceCollision(StaticQuadtree<T>     &tree,
                                    const Ray             &ray_,
                                    Storm3D_CollisionInfo &info_,
                                    bool                   accurate_)
        :   ray(ray_),
        info(info_),
        accurate(accurate_)
...
template <class T> class StaticQuadtreeSphereCollision {
    ...
    StaticQuadtreeSphereCollision(StaticQuadtree<T>     &tree,
...
template <class T> StaticQuadtree<T>::StaticQuadtree(const VC2 &min_, const VC2 &max_)
    :   root(0)
{
...
template <class T> StaticQuadtree<T>::~StaticQuadtree()
{
    delete root;
}

template <class T> void StaticQuadtree<T>::insert(T         &instance,
                                                  const VC3 &position,
                                                  float      radius,
                                                  float      heightMin,
                                                  float      heightMax)
...
template <class T> void StaticQuadtree<T>::RayTrace(Ray &ray, Storm3D_CollisionInfo &info, bool accurate)
{
    StaticQuadtreeRaytraceCollision<T> rayTracer(*this, ray, info, accurate);
}

template <class T> void StaticQuadtree<T>::SphereCollision(Sphere &sphere, Storm3D_CollisionInfo &info, bool accurate)
{
