    ...
    namespace exporter {
        namespace {
            ...
            struct JunctionFace {
                ...
                void SphereCollision(const VC3 &position, double radius, Storm3D_CollisionInfo &info,
                                     bool accurate) const
                {
            ...
            struct SnapVertex {
                ...
                void SphereCollision(const VC3             &otherPosition,
                                     double                 radius,
        ...
        void chopFaces(Object &object)
        {
            ...
            for (unsigned int i = 0; i < faces.size(); ) {
                ...
                assert( !( f1.getVertexIndex(0) == face.getVertexIndex(0) && f1.getVertexIndex(1) ==
                           face.getVertexIndex(1) && f1.getVertexIndex(2) == face.getVertexIndex(2) ) );
                assert( !( f2.getVertexIndex(0) == face.getVertexIndex(0) && f2.getVertexIndex(1) ==
                           face.getVertexIndex(1) && f2.getVertexIndex(2) == face.getVertexIndex(2) ) );
