...
void Storm3D_VideoPlayer::play()
{
	...
	while(!data->streamer->hasEnded())
	{
		...
		if (Keyb3_IsKeyPressed(KEYCODE_ESC) || Keyb3_IsKeyPressed(KEYCODE_SPACE) || Keyb3_IsKeyPressed(KEYCODE_ENTER) || Keyb3_IsKeyPressed(KEYCODE_MOUSE_BUTTON1) || Keyb3_IsKeyPressed(KEYCODE_MOUSE_BUTTON2) || Keyb3_IsKeyPressed(KEYCODE_MOUSE_BUTTON3))
			break;
	}
}
