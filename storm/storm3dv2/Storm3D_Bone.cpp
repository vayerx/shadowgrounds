 ...
 */
void Storm3D_Bone::SetOriginalProperties(const Vector   &position,
                                         const Rotation &rotation,
                                         const Vector   &model_position,
...
/*!
    ...
    \param interpolate true to use interpolation
 */
void Storm3D_Bone::AnimateRelativeRotation(const Rotation &animated_rotation,
