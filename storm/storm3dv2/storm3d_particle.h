...
public:
    ...
    public:
        PointArray(IStorm3D_Material     *mtl,
                   Storm3D_PointParticle *parts,
                   int                    nParts,
                   const COL             &factor_,
                   bool                   distortion_)
    ...
    public:
        QuadArray(IStorm3D_Material                    *mtl,
                  Storm3D_PointParticle                *parts,
                  int                                   nParts,
                  Storm3D_ParticleTextureAnimationInfo *info,
                  const COL                            &factor_,
                  bool                                  distortion_,
                  bool                                  faceUp_)
            : m_parts(parts), m_numParts(nParts), m_partOffset(0), m_mtl(mtl), factor(factor_), distortion(distortion_),
    ...
    public:
        LineArray(IStorm3D_Material                    *mtl,
                  Storm3D_LineParticle                 *parts,
                  int                                   nParts,
                  Storm3D_ParticleTextureAnimationInfo *info,
                  const COL                            &factor_,
                  bool                                  distortion_)
    ...
    void renderPoints(IStorm3D_Material     *mtl,
                      Storm3D_PointParticle *parts,
                      int                    nParts,
                      const COL             &factor,
                      bool                   distortion) {
