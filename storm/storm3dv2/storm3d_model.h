...
public:
    ...
    Model_BoneAnimation(Storm3D_BoneAnimation *transition,
                        Storm3D_BoneAnimation *animation,
                        bool                   looping = true,
                        int                    blend_time = 0,
...
public:
    ...
    IStorm3D_Helper_Camera *Helper_Camera_New(const char *name,
                                              const VC3  &_position,
    ...
    bool BlendToAnimation(IStorm3D_BoneAnimation *transition,
                          IStorm3D_BoneAnimation *animation,
                          int                     blend_time,
                          bool                    loop = true);
    // Blending with animations.
    bool BlendWithAnimationIn(IStorm3D_BoneAnimation *transition,
                              IStorm3D_BoneAnimation *animation,
                              int                     blend_in_time,
                              bool                    loop = true,
                              float                   blend_factor = 1.f);
    bool BlendWithAnimationOut(IStorm3D_BoneAnimation *transition,
                               IStorm3D_BoneAnimation *animation,
                               int                     blend_out_time);
    // Manual
