...
struct Storm3D_VideoPlayerData {
    ...
    Storm3D_VideoPlayerData(Storm3D                      &storm_,
                            Storm3D_Scene                &scene_,
                            const char                   *filename,
                            class IStorm3D_StreamBuilder *streamBuilder_)
        :   storm(storm_),
        scene(scene_),
...
Storm3D_VideoPlayer::Storm3D_VideoPlayer(Storm3D                &storm,
                                         Storm3D_Scene          &scene,
                                         const char             *fileName,
                                         IStorm3D_StreamBuilder *streamBuilder)
{
    boost::scoped_ptr<Storm3D_VideoPlayerData> tempData( new Storm3D_VideoPlayerData(storm,
                                                                                     scene,
                                                                                     fileName,
                                                                                     streamBuilder) );
    data.swap(tempData);
