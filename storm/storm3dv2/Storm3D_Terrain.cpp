...
void Storm3D_Terrain::setHeightMap(const unsigned short *buffer,
...
{
    data->heightMap.setHeightMap(buffer,
                                 resolution,
                                 size,
                                 textureDetail,
                                 forceMap,
                                 heightmapMultiplier,
                                 obstaclemapMultiplier);
...
int Storm3D_Terrain::addModel(boost::shared_ptr<IStorm3D_Model> model,
...
void Storm3D_Terrain::rayTrace(const VC3             &position,
