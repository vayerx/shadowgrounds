...
//! Constructor
Storm3D_Model_Object::Storm3D_Model_Object(Storm3D                 *s2,
                                           const char              *name,
                                           Storm3D_Model           *_parent_model,
                                           Storm3D_ResourceManager &resourceManager_) :
    Storm3D2(s2),
...
void Storm3D_Model_Object::AddChild(IStorm3D_Helper *ihelper)
{
    switch ( ihelper->GetHelperType() ) {
    case IStorm3D_Helper::HTYPE_POINT:
        if ( ( (Storm3D_Helper_Point *)ihelper )->parent_object ) ( (Storm3D_Helper_Point *)ihelper )->parent_object->
            RemoveChild(ihelper);
        ( (Storm3D_Helper_Point *)ihelper )->parent_object = this;
        break;

    case IStorm3D_Helper::HTYPE_VECTOR:
        if ( ( (Storm3D_Helper_Point *)ihelper )->parent_object ) ( (Storm3D_Helper_Vector *)ihelper )->parent_object->
            RemoveChild(ihelper);
        ( (Storm3D_Helper_Vector *)ihelper )->parent_object = this;
        break;

    case IStorm3D_Helper::HTYPE_CAMERA:
        if ( ( (Storm3D_Helper_Camera *)ihelper )->parent_object ) ( (Storm3D_Helper_Camera *)ihelper )->parent_object
            ->RemoveChild(ihelper);
        ( (Storm3D_Helper_Camera *)ihelper )->parent_object = this;
        break;

    case IStorm3D_Helper::HTYPE_BOX:
        if ( ( (Storm3D_Helper_Point *)ihelper )->parent_object ) ( (Storm3D_Helper_Box *)ihelper )->parent_object->
            RemoveChild(ihelper);
        ( (Storm3D_Helper_Box *)ihelper )->parent_object = this;
        break;

    case IStorm3D_Helper::HTYPE_SPHERE:
        if ( ( (Storm3D_Helper_Sphere *)ihelper )->parent_object ) ( (Storm3D_Helper_Sphere *)ihelper )->parent_object
            ->RemoveChild(ihelper);
 ...
 */
void Storm3D_Model_Object::RayTrace(const VC3             &position,
                                    ...
                                    bool                   accurate)
{
    ...
    if (parent_model->no_collision)
        return;
    if (rti.onlySolidSurfaces && mesh && mesh->GetMaterial() && mesh->GetMaterial()->GetAlphaType() !=
        IStorm3D_Material::ATYPE_NONE)
        return;
...
/*!
    ...
    \param accurate true to use accurate collision detection
 */
void Storm3D_Model_Object::SphereCollision(const VC3             &position,
                                           float                  radius,
