...
typedef vector<boost::shared_ptr<Instance> > ModelInstanceList;
...
struct SharedModel {
    ...
    SharedModel(boost::shared_ptr<IStorm3D_Model> model_,
                boost::shared_ptr<IStorm3D_Model> fadeModel_,
                const std::string         &bones_,
                const std::string         &idleAnimation_)
        :   model(model_),
 ...
 */
int Storm3D_TerrainGroup::addModel(boost::shared_ptr<Storm3D_Model> model,
                                   boost::shared_ptr<Storm3D_Model> fadeModel,
...
/*!
    ...
    \return iterator
 */
boost::shared_ptr<IStorm3D_TerrainModelIterator> Storm3D_TerrainGroup::getModelIterator(const VC3 &position,
                                                                                        float      radius)
{
    return boost::shared_ptr<IStorm3D_TerrainModelIterator>( new TerrainIterator(data->tree.get(), position, radius,
                                                                                 data->terrainModels) );
}
