...
namespace frozenbyte {
    namespace storm {
        ...
        void PixelShader::createPixelShader(const std::string &name) {
            ...
            glProgramStringARB( GL_FRAGMENT_PROGRAM_ARB, GL_PROGRAM_FORMAT_ASCII_ARB, strlen(
                                     shaderString.c_str() ), shaderString.c_str() );
        ...
        void VertexShader::createVertexShader(const std::string &name) {
            ...
            // WHAT THE FUCK is wrong with shaderString.length() ?
            glProgramStringARB( GL_VERTEX_PROGRAM_ARB, GL_PROGRAM_FORMAT_ASCII_ARB, strlen(
                                     shaderString.c_str() ), shaderString.c_str() );
        ...
        void VertexShader::createFakePlaneShadowShader()
        {
            elements.clear();
            elements.push_back( Element(0, 0, D3DDECLTYPE_FLOAT3, D3DDECLUSAGE_POSITION) );
            elements.push_back( Element(0, 3 * 4, D3DDECLTYPE_FLOAT4, D3DDECLUSAGE_COLOR, 0) );
