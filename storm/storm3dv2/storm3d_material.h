...
public:
    ...
    void SetReflectionTexture(IStorm3D_Texture *texture,
    ...
    void ChangeReflectionTextureParameters(MTL_BOP op = MTL_BOP_ADD,
                                           float   blend_factor = 0.5f,
                                           TEX_GEN texgen = TEX_GEN_REFLECTION);
...
class Storm3D_Material_TextureLayer {
    ...
    Storm3D_Material_TextureLayer(Storm3D                  *Storm3D2,
                                  Storm3D_Texture          *_texture,
                                  Storm3D_Material::MTL_BOP blend_op = Storm3D_Material::MTL_BOP_MUL,
                                  float                     blend_factor = 0.5f,
