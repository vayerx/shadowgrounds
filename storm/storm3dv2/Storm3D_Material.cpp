...
Storm3D_Material::Storm3D_Material(Storm3D *s2, const char *_name) :
    ...
    shader_handle(0),
    scrollSpeed1(0.0f, 0.0f),
    scrollOffset1(0.0f, 0.0f),
    scrollSpeed2(0.0f, 0.0f),
    scrollOffset2(0.0f, 0.0f),
    scrollEnabled(false),
    scrollUpdateFrame(-1),
 ...
 */
void Storm3D_Material::SetBaseTexture2(IStorm3D_Texture         *itexture,
...
/*
    ...
    \param blend_factor blending factor
 */
void Storm3D_Material::SetReflectionTexture(IStorm3D_Texture         *itexture,
                                            TEX_GEN                   texgen,
                                            Storm3D_Material::MTL_BOP blend_op,
                                            float                     blend_factor)
{
    ...
    // Create new texturelayer
    if (texture) texture_reflection = new Storm3D_Material_TextureLayer(Storm3D2,
                                                                        texture,
                                                                        blend_op,
                                                                        blend_factor,
                                                                        texgen);
...
bool Storm3D_Material::Apply(Storm3D_Scene *scene, int pass, uint32_t fvf, D3DMATRIX *mtx)
{
    ...
    } else if (alphablend_type == ATYPE_USE_TEXTRANSPARENCY || alphablend_type ==
