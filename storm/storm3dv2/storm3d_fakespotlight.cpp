...
bool Storm3D_FakeSpotlight::setAsRenderTarget(const D3DXMATRIX &cameraView)
{
    ...
    if ( data->renderTarget && data->renderTarget->set() ) {
        ...
        Storm3D_ShaderManager::GetSingleton()->setSpot(
            COL(), data->properties.position, data->properties.direction, data->properties.range, .1f);
    ...
    Storm3D_ShaderManager::GetSingleton()->setFakeProperties(data->properties.position.y - data->plane.height,
                                                             .1f,
                                                             .3137f);
