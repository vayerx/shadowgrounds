...
struct ProceduralEffect {
    ...
    void     init(Storm3D &storm)
    {
        if ( !effect.source1.texture.texture.empty() ) {
            Storm3D_Texture *t1 =
                static_cast<Storm3D_Texture *>( storm.CreateNewTexture( effect.source1.texture.texture.c_str() ) );
            if (t1) {
        ...
        if ( !effect.source2.texture.texture.empty() ) {
            Storm3D_Texture *t2 =
                static_cast<Storm3D_Texture *>( storm.CreateNewTexture( effect.source2.texture.texture.c_str() ) );
            if (t2) {
        ...
        if ( !effect.source1.offset.texture.empty() ) {
            Storm3D_Texture *t3 =
                static_cast<Storm3D_Texture *>( storm.CreateNewTexture( effect.source1.offset.texture.c_str() ) );
            if (t3) {
        ...
        if ( !effect.source2.offset.texture.empty() ) {
            Storm3D_Texture *t4 =
                static_cast<Storm3D_Texture *>( storm.CreateNewTexture( effect.source2.offset.texture.c_str() ) );
            if (t4) {
        ...
        if ( !effect.distortion1.offset.texture.empty() ) {
            Storm3D_Texture *t5 =
                static_cast<Storm3D_Texture *>( storm.CreateNewTexture( effect.distortion1.offset.texture.c_str() ) );
            if (t5) {
        ...
        if ( !effect.distortion2.offset.texture.empty() ) {
            Storm3D_Texture *t6 =
                static_cast<Storm3D_Texture *>( storm.CreateNewTexture( effect.distortion2.offset.texture.c_str() ) );
            if (t6) {
 ...
 */
void Storm3D_ProceduralManager::setTarget(boost::shared_ptr<glTexWrapper> target,
                                          boost::shared_ptr<glTexWrapper> offsetTarget)
{
