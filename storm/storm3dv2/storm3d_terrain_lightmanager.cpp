...
Storm3D_LightTexture::Storm3D_LightTexture(const VC2        &start_,
                                           const VC2        &end_,
                                           IStorm3D_Texture &texture_,
                                           const COL        &color_)
    :   start(start_),
    end(end_),
    color(color_)
{
    texture =
        boost::shared_ptr<Storm3D_Texture>( static_cast<Storm3D_Texture *>(&texture_),
...
struct Storm3D_TerrainLightManager::Data {
    ...
    Data(Storm3D                      &storm_,
         IStorm3D_TerrainRendererBase &renderer_,
         StormSpotList                &spots_,
         FakeSpotList                 &fakeSpots_,
         FakeLightList                &fakeLights_)
        :   storm(storm_),
        renderer(renderer_),
        spots(spots_),
    ...
    void renderFakeLights(const VC2I &renderSize)
    {
        ...
        // For glDrawArrays below, used instead of renderUP
...
//! Constructor
Storm3D_TerrainLightManager::Storm3D_TerrainLightManager(Storm3D                      &storm,
                                                         IStorm3D_TerrainRendererBase &renderer,
                                                         StormSpotList                &spots,
                                                         FakeSpotList                 &fakeSpots,
                                                         FakeLightList                &fakeLights)
 ...
 */
void Storm3D_TerrainLightManager::renderProjectedRenderTargets(Storm3D_Scene &scene,
                                                               bool           renderShadows,
                                                               bool           renderFakeBuffers)
{
