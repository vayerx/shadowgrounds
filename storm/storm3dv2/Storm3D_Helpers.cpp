...
Storm3D_Helper_Camera::Storm3D_Helper_Camera(const char    *_name,
...
Storm3D_Helper_Vector::Storm3D_Helper_Vector(const char    *_name,
                                             Storm3D_Model *_parent_model,
                                             VC3            _position,
                                             VC3            _direction) :
    Storm3D_Helper_AInterface(_name, _parent_model, _position, this),
...
Storm3D_Helper_Sphere::Storm3D_Helper_Sphere(const char    *_name,
                                             Storm3D_Model *_parent_model,
                                             VC3            _position,
                                             float          _radius) :
    Storm3D_Helper_AInterface(_name, _parent_model, _position, helper),
