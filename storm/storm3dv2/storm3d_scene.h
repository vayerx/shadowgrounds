...
public:
    ...
    void RenderSceneWithParams(bool              flip = true,
                               bool              disable_hsr = false,
                               bool              update_time = true,
                               bool              render_mirrored = false,
                               IStorm3D_Texture *target = NULL);
    ...
    void Render2D_Picture(IStorm3D_Material *mat,
                          VC2                position,
                          VC2                size,
                          float              alpha,
                          float              rotation,
    ...
    void Render2D_Text(IStorm3D_Font *font,
                       VC2            position,
                       VC2            size,
                       const char    *text,
                       float          alpha,
