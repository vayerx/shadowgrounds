...
#define LOG_ERROR_W_DEBUG(msg, debugmsg)               Logger::getInstance()->error(msg); Logger::getInstance()->debug( \
        debugmsg)
#define LOG_ERROR_W_DEBUG2(msg, debugmsg, debugmsg2)   Logger::getInstance()->error(msg); Logger::getInstance()->debug( \
        debugmsg); Logger::getInstance()->debug(debugmsg2)
#define LOG_WARNING(msg)                               Logger::getInstance()->warning(msg)
#define LOG_WARNING_W_DEBUG(msg, debugmsg)             Logger::getInstance()->warning(msg); \
    Logger::getInstance()->debug(debugmsg)
#define LOG_WARNING_W_DEBUG2(msg, debugmsg, debugmsg2) Logger::getInstance()->warning(msg); \
    Logger::getInstance()->debug(debugmsg); Logger::getInstance()->debug(debugmsg2)
