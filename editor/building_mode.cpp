        ...
        namespace {
            struct SharedData {
                ...
                void updateDialog()
                {
                    ...
                    for (int i = 0; i < terrainBuildings.getModelCount(); ++i) {
                        ...
                        SendDlgItemMessage(
                             dialog.getWindowHandle(), IDC_BUILDING_MODELS, LB_ADDSTRING, 0,
            ...
            class InsertBuildingMode {
                ...
                void loadModel()
                {
                    ...
                    boost::shared_ptr<IStorm3D_Model> newModel = createEditorModel(
                         *sharedData.storm.storm, sharedData.terrainBuildings.getModel(selection) );
                    model = newModel;
