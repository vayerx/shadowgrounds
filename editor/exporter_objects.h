...
namespace frozenbyte {
    namespace editor {
        ...
        public:
            ...
            int addTerrainObject(const std::string &fileName,
                                 CollisionType type,
                                 FallType fallType,
                                 float height,
                                 float radius,
                                 bool fireThrough,
                                 const std::string &explosionObject,
                                 const std::string &explosionScript,
                                 const std::string &explosionProjectile,
                                 const std::string &explosionEffect,
