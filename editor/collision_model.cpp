...
namespace frozenbyte {
    namespace editor {
        ...
        CollisionModel::CollisionModel(ObjectData   &data_,
                                       const COL    &color,
        ...
        struct CollisionVolumeData {
            ...
            bool accurateCollision(const VC3     &objectPosition,
                                   CollisionData &collisionData,
                                   const VC3     &rayOrigin_,
                                   const VC3     &rayDirection_)
            {
                bool inside = true;
                int i = 0;
        ...
        bool CollisionVolume::testCollision(const VC3     &objectPosition,
                                            const VC3     &angles,
                                            CollisionData &collisionData,
                                            float          epsilon)
        {
            ...
            VC3 pos =
                tm.GetInverse().GetTransformedVector(collisionData.collisionPosition - objectPosition) + objectPosition;
