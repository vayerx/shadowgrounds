...
//>>>>>>> 1.9
                ...
                TextureDialog(Dialog &parent, Storm &storm) : dlg( IDD_PTEX,
                                                                   parent.getWindowHandle() ), data(dlg, storm),
            ...
            public:
                ...
                public:
                    ...
                    void updateValues() {
                        ...
                        ed->randomDirection =
                            (Button_GetCheck( GetDlgItem(dlg.getWindowHandle(),
                                                         IDC_CE_RANDOM_DIRECTION) ) == BST_CHECKED)
                            ? true : false;
            ...
            public:
                ...
                struct Data {
                    ...
                    void updateValues() {
                        ed->dieAfterEmission =
                            (Button_GetCheck( GetDlgItem(dlg.getWindowHandle(),
                                                         IDC_E_DIE_AFTER_EMISSION) ) == BST_CHECKED)
                            ? true : false;
