...
namespace frozenbyte {
    namespace editor {
        namespace {
            ...
            struct SharedData {
                    ...
                    showEditorOnly(true)
                {
                    ...
                    SendDlgItemMessage( dialog.getWindowHandle(), IDC_RENDER_MODE, CB_ADDSTRING, 0,
                                        reinterpret_cast<LPARAM>("Textures + light buffer") );
                    SendDlgItemMessage( dialog.getWindowHandle(), IDC_RENDER_MODE, CB_ADDSTRING, 0,
                                        reinterpret_cast<LPARAM>("Light buffer") );
                    SendDlgItemMessage( dialog.getWindowHandle(), IDC_RENDER_MODE, CB_ADDSTRING, 0,
                                        reinterpret_cast<LPARAM>("Textures only") );
                ...
                void updateValues()
                {
                    ...
                    bool gameCamera =
                        IsDlgButtonChecked(dialog.getWindowHandle(), IDC_FORCE_GAME_CAMERA) == BST_CHECKED;
            ...
            struct RendererCommand : public ICommand {
                ...
                void execute(int id)
                {
                    ...
                    bool renderDistortion =
                        IsDlgButtonChecked(dialog.getWindowHandle(), IDC_RENDER_DISTORTION) == BST_CHECKED;
                    bool renderWireframe =
                        IsDlgButtonChecked(dialog.getWindowHandle(), IDC_FORCE_WIREFRAME) == BST_CHECKED;
                    bool renderCollision =
                        IsDlgButtonChecked(dialog.getWindowHandle(), IDC_FORCE_COLLISION) == BST_CHECKED;
                    ...
                    bool renderTriggers =
                        IsDlgButtonChecked(dialog.getWindowHandle(), IDC_SHOW_TRIGGERS) == BST_CHECKED;
                    bool renderHelpers = IsDlgButtonChecked(dialog.getWindowHandle(), IDC_SHOW_HELPERS) == BST_CHECKED;
                    bool renderIncomplete =
                        IsDlgButtonChecked(dialog.getWindowHandle(), IDC_SHOW_INCOMPLETE) == BST_CHECKED;
                    ...
                    bool renderNoCollision =
                        IsDlgButtonChecked(dialog.getWindowHandle(), IDC_SHOW_NOCOLLISION) == BST_CHECKED;
                    ...
                    bool renderHeightmap =
                        IsDlgButtonChecked(dialog.getWindowHandle(), IDC_RENDER_HEIGHTMAP) == BST_CHECKED;
                    bool freezeCameraCulling =
                        IsDlgButtonChecked(dialog.getWindowHandle(), IDC_FREEZE_CAMERA_CULLING) == BST_CHECKED;
                    bool aniso = IsDlgButtonChecked(dialog.getWindowHandle(), IDC_ANISO) == BST_CHECKED;
                    bool smoothShadows =
                        IsDlgButtonChecked(dialog.getWindowHandle(), IDC_SMOOTH_SHADOWS) == BST_CHECKED;
            ...
            public:
                ...
                void end()
                {
                    ...
                    SendMessage(
                        gui.getSceneDialog().getWindowHandle(), WM_COMMAND, IDC_RENDER_HEIGHTMAP, IDC_RENDER_HEIGHTMAP);
        ...
        {
            boost::scoped_ptr<SceneModeData> tempData( new SceneModeData(gui.getSceneDialog(), storm, gui.getMenuDialog(
                                                                             ), editorState, gui) );
            data.swap(tempData);
        }
        ...
        void SceneMode::doExport(Exporter &exporter) const
        {
...

            {
                ...
                for (FogMap::const_iterator it = data->sharedData.fogMap.begin();
                     it != data->sharedData.fogMap.end();
                     ++it) {
                    const Fog &f = it->second;
