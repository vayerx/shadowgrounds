    ...
    namespace editor {
        ...
        namespace {
            ...
            struct SharedData {
                ...
                void save()
                {
                    ...
                    if ( UniqueEditorObjectHandleManager::wasError() )
                        MessageBox(
                            0,
                            "Failed to save unique handle iterator value.\r\n\r\nThis may cause non-unique object handles in the future.\r\n(Changes made to maps in game may get read back to editor incorrectly.)",
                            "Warning",
            ...
            public:
                ...
                void execute(int id)
                {
                    ...
                    CheckRadioButton(
                        gui.getMenuDialog().getWindowHandle(), IDC_MENU_TERRAIN, IDC_MENU_LIGHTS, IDC_MENU_SCENE);
                    ...
                    SendMessage(
                        gui.getMenuDialog().getWindowHandle(), WM_COMMAND, IDC_LIGHT_VISUALIZATION,
                        IDC_LIGHT_VISUALIZATION);
            ...
            public:
                ...
                void execute(int id)
                {
                    ...
                    if ( !options.fileName.empty() ) {
                        ...
                        CheckDlgButton(gui.getBuildingsDialog().getWindowHandle(), IDC_HIDE_ROOF, BST_CHECKED);
                        SendMessage(
                            gui.getBuildingsDialog().getWindowHandle(), WM_COMMAND, IDC_HIDE_ROOF, IDC_HIDE_ROOF);
                    }
                }
            };
            ...
            public:
                ...
                void menuCommand()
                {
                    ...
                    if (file == NULL) {
                        MessageBox(0,
                                   ("Cannot open file " + fileName).c_str(), "Multi-export error!",
                                   MB_ICONEXCLAMATION | MB_OK);
                        return;
                    }
        ...
        struct ApplicationData {
            ...
            void handleMessage()
            {
                ...
                if (windowsMessage.message == WM_LBUTTONDOWN || windowsMessage.message == WM_ACTIVATE ||
                    windowsMessage.message == WM_NCLBUTTONDOWN)
 ...
 */
            ...
            if ( UniqueEditorObjectHandleManager::wasError() )
                ...
                MessageBox(
                    0,
                    "Editor unique handle files were successfully initialized.\r\n\r\n(This should happen during first use of editor.)",
                    "Information",
                    MB_OK);
