        ...
        namespace {
            ...
            class UpdateCommand : public ICommand {
                ...
                void setNames()
                {
                    ...
                    for (unsigned int i = 0; i < sharedData.fileNames.size(); ++i) {
                        ...
                        SendDlgItemMessage(
                             dialog.getWindowHandle(), IDC_MISSION_NAMES, LB_ADDSTRING, 0,
            ...
            public:
                ...
                void execute(int id)
                {
                    ...
                    SendDlgItemMessage( dialog.getWindowHandle(), IDC_MISSIONFOLDER, CB_ADDSTRING, 0,
                                        reinterpret_cast<LPARAM>("Campaign") );
#ifdef PROJECT_SURVIVOR
                    SendDlgItemMessage( dialog.getWindowHandle(), IDC_MISSIONFOLDER, CB_ADDSTRING, 0,
                                        reinterpret_cast<LPARAM>("Survival") );
#endif
            ...
            public:
                ...
                void execute(int id)
                {
                    ...
                    sharedData.onlyScripts =
                        IsDlgButtonChecked(dialog.getWindowHandle(), IDC_SCRIPT_ONLY) == BST_CHECKED;
                    dialog.hide();
                }
            };
...
#ifdef LEGACY_FILES
                    std::string command = "\"" + dir + "\\tools\\missioncreator.exe\" " + mission_folder
