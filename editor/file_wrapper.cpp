...
// probably not. FIXME
        ...
        struct FileWrapper::Data {
            ...
            {
                boost::shared_ptr<IFileList> list = FilePackageManager::getInstance().findFiles(root,
                                                                                                extension,
                                                                                                caseSensitive);
                if (!list)
                    return;
...
// TEST HACK: fbem modifier files..
        ...
        std::string FileWrapper::resolveModelName(const std::string &rootDir, const std::string &fileName)
        {
            ...
            boost::shared_ptr<IFileList> fileList = filesystem::FilePackageManager::getInstance().findFiles(rootDir,
                                                                                                            "*" + file);
