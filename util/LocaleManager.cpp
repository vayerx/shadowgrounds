...
#  ifdef LEGACY_FILES
                frozenbyte::filesystem::InputStream stream =
                    frozenbyte::filesystem::FilePackageManager::getInstance().getFile("Data/Locales/ru/launcher.txt");
#  else
                frozenbyte::filesystem::InputStream stream =
                    frozenbyte::filesystem::FilePackageManager::getInstance().getFile("data/locale/ru/launcher.txt");
#  endif
            ...
            bool getNextPair(const std::wstring &buffer,
                             int                &start,
                             int                 fileEnd,
                             std::wstring       &key,
                             std::wstring       &value)
