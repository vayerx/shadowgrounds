...
namespace profiler {
	...
	void pushIdentifier(const char *className, const char *id, const char *part) __attribute__((visibility("default")));
	...
	#define FB_PROFILE_FUNC() frozenbyte::profiler::ProfilerImplementationClass profilerImplementationClass(__FUNCTION__)
	#define FB_PROFILE_CLASS_FUNC(className) frozenbyte::profiler::ProfilerImplementationClass profilerImplementationClass(className, __FUNCTION__)
	...
	#define FB_PROFILE_FUNC_PART(part) frozenbyte::profiler::ProfilerImplementationClass part(0, __FUNCTION__, #part)
	#define FB_PROFILE_CLASS_FUNC_PART(className, part) frozenbyte::profiler::ProfilerImplementationClass part(className, __FUNCTION__, #part)
