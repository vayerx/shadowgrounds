...
namespace util
{
    std::string StringReplace(const std::string &what,
                              const std::string &with,
                              const std::string &in_here,
                              int                limit = -1);
...
// does find firt of so that the given tag is not inside the given characters,
    std::string::size_type StringFindNotInside(const std::string            &what,
                                               const std::string            &in_here,
                                               const std::string::size_type &begin = 0,
                                               const std::string             begin_char = "\"",
                                               const std::string             end_char = "\"");
