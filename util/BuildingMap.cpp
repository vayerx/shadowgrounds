...
// and the same for heightmap...
    ...
    struct BuildingMapData {
        ...
        void sphereCollision(IStorm3D_Model        *model,
                             const VC3             &position,
                             float                  radius,
        ...
        void floodfillInteriors()
        {
...

            {
                ...
                Logger::getInstance()->debug(
                    "BuildingMap::floodfillInteriors - Total number of entrance/door points follows:");
...
//#endif
                ...
                util::Floodfill::fillWithByte(BMAP_FLOODFILL_REACHABLE_uint8_t,
                                              0,
                                              xResolution,
                                              yResolution,
                                              &mapper,
...
/* BuildingMap */
    ...
    BuildingMap::BuildingMap(const char     *fileNameRaw,
                             ...
                             int             rotationZ)
    {
        ...
        {
            Logger::getInstance()->warning(
                "BuildingMap - Buildingmap is not up to date, but it will not be recreated (auto recreate off).");
            upToDate = true;
        }
