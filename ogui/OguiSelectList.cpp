...
void OguiSelectList::CursorEvent(OguiButtonEvent *eve)
{
    ...
    bool scrollup = eve->eventType == OguiButtonEvent::EVENT_TYPE_CLICK &&
                    (eve->cursorOldButtonMask & OGUI_BUTTON_WHEEL_UP_MASK);
    bool scrolldown = eve->eventType == OguiButtonEvent::EVENT_TYPE_CLICK &&
    ...
    if (listener != NULL) {
        ...
        if (sendEvent) {
            OguiSelectListEvent *tmp = new OguiSelectListEvent(et,
                                                               eve->cursorNumber,
                                                               eve->cursorScreenX,
                                                               eve->cursorScreenY,
                                                               eve->cursorButtonMask,
                                                               eve->cursorOldButtonMask,
                                                               num,
                                                               val,
                                                               desc,
                                                               scrolly,
...
void OguiSelectList::init(int                  x,
                          int                  y,
                          int                  defsel,
                          bool                 multisel,
                          int                  amount,
...
OguiSelectList::OguiSelectList(int                  x,
                               int                  y,
                               int                  defsel,
                               bool                 multisel,
                               int                  amount,
