...
#define OG_CTRL_MASK_MICE                  (OG_CTRL_MASK_MOUSE | OG_CTRL_MASK_MOUSE0 | OG_CTRL_MASK_MOUSE1 \
                                            | OG_CTRL_MASK_MOUSE2 | OG_CTRL_MASK_MOUSE3 | OG_CTRL_MASK_MOUSE4)
...
void og_write_text_transp( orvgui_win *win, IStorm3D_Font *font, short x, short y, char *text, short fontwidth,
                           short fontheight, float alpha = 1.0f, const COL &color = COL(1.f, 1.f,
                                                                                        1.f) );
