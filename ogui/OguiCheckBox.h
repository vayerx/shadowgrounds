...
public:
    ...
    OguiCheckBox(OguiWindow        *win,
                 Ogui              *ogui,
                 int                x,
                 int                y,
                 int                w,
                 int                h,
                 const std::string &checkbox_false_norm,
                 std::string        checkbox_false_down,
                 std::string        checkbox_false_high,
                 const std::string &checkbox_true_norm,
                 const std::string &checkbox_true_down = "",
                 const std::string &checkbox_true_high = "",
                 int                sid = 0,
                 bool               value = true,
                 bool               changeOnClick = true);
    ~OguiCheckBox();
    ...
    void setText(const std::string       &text,
                 TEXT_ALIGN               align = TEXT_ALIGN_RIGHT,
                 int                      w = 200,
                 IOguiFont               *font = NULL,
                 OguiButton::TEXT_V_ALIGN valign = OguiButton::TEXT_V_ALIGN_TOP);
