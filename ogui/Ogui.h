...
public:
     ...
     */
    void SetCursorControllerKeyboard(int cursornum,
                                     int key_left,
                                     int key_right,
                                     int key_up,
                                     int key_down,
    ...
    OguiButton *CreateSimpleImageButton(OguiWindow *win,
                                        int         x,
                                        int         y,
                                        int         sizex,
                                        int         sizey,
    ...
    OguiButton *CreateSimpleTextButton(OguiWindow *win,
                                       int         x,
                                       int         y,
                                       int         sizex,
                                       int         sizey,
    ...
    OguiSelectList *CreateSelectList(OguiWindow          *win,
                                     int                  x,
                                     int                  y,
