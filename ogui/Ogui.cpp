...
void Ogui::SetCursorControllerKeyboard(int cursornum,
                                       int key_left,
                                       int key_right,
                                       int key_up,
                                       int key_down,
...
throw (OguiException *)
{
    if ( cursornum < 0 || cursornum >= GetMaxCursors() )
        Logger::getInstance()->warning("Ogui::SetCursorController - Cursor number out of bounds.");
     // NOTE: make sure orvgui and Ogui mask definitions are the same!
    og_set_cursor_control_keyboard( (unsigned char)cursornum, key_left, key_right, key_up, key_down, key_fire,
                                    key_fire2 );
}
...
OguiButton *Ogui::CreateSimpleImageButton(OguiWindow *win,
                                          int         x,
                                          int         y,
                                          int         sizex,
                                          int         sizey,
                                          const char *imageFilename,
                                          const char *imageDownFilename,
                                          const char *imageHighlightFilename,
                                          const char *imageDisabledFilename,
                                          int         id,
                                          void       *argument,
                                          bool        clipToWindow)
throw (OguiException *)
...
OguiButton *Ogui::CreateSimpleTextButton(OguiWindow *win,
                                         int         x,
                                         int         y,
                                         int         sizex,
                                         int         sizey,
...
OguiSelectList *Ogui::CreateSelectList(OguiWindow          *win,
                                       int                  x,
                                       int                  y,
...
throw (OguiException *)
{
    ...
    OguiButton *upsb = win->CreateNewButton(x + butSizeX,
                                            y,
                                            style->scrollSizeX,
                                            style->scrollSizeY,
                                            NULL,
                                            ...
                                            NULL,
                                            NULL);
    OguiButton *downsb = win->CreateNewButton(x + butSizeX,
                                              y + style->sizeY - style->scrollSizeY,
                                              style->scrollSizeX,
                                              style->scrollSizeY,
                                              NULL,
                                              NULL,
