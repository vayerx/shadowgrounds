...
OguiSlider::OguiSlider(OguiWindow        *win,
                       Ogui              *ogui,
                       int                x,
                       int                y,
                       int                w,
    ...
    disabledForeground(NULL)
{
    ...
    foreground = ogui->CreateSimpleImageButton(win, x, y, w, h,
                                               ...
                                               foreground_norm.empty() ? NULL : foreground_norm.c_str(), foregroundId,
                                               NULL);
...
{
    bool wheelup = (eve->cursorOldButtonMask & OGUI_BUTTON_WHEEL_UP_MASK) ||
                   (eve->cursorButtonMask & OGUI_BUTTON_WHEEL_UP_MASK);
    bool wheeldown = (eve->cursorOldButtonMask & OGUI_BUTTON_WHEEL_DOWN_MASK) ||
                     (eve->cursorButtonMask & OGUI_BUTTON_WHEEL_DOWN_MASK);
...
OguiGfxSlider::OguiGfxSlider(OguiWindow        *win,
                             Ogui              *ogui,
                             int                x,
                             int                y,
                             int                w,
                             ...
                             int                id,
                             float              value) :
    OguiSlider(win, ogui, x, y, w, h, background_norm, background_down, background_high, foreground_norm,
               foreground_down, foreground_high, id, value)
{
    Initialize();
}
