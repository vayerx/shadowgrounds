...
public:
    ...
    OguiButton *LoadButton(const std::string &button_name, OguiWindow *window, int id)
    {
        ...
        std::string img_selected = getLocaleString(std::string(
                                                       "gui_") + window_name + "_" + button_name + "_img_selected");
        std::string img_selected_high = getLocaleString(std::string(
                                                            "gui_") + window_name + "_" + button_name
                                                        + "_img_selected_high");

        // fonts
        std::string font_normal = getLocaleString(std::string(
                                                      "gui_") + window_name + "_" + button_name + "_font_normal");
        ...
        std::string font_disa = getLocaleString(std::string(
                                                    "gui_") + window_name + "_" + button_name + "_font_disabled");
    ...
    OguiSelectList *LoadSelectList(const std::string &name, OguiWindow *window, int id)
    {
        ...
        OguiSelectListStyle *selectListStyle = NULL;
        {
            ...
            OguiButtonStyle *newUnStyle = LoadStyle(std::string(
                                                        "gui_") + window_name + "_" + name + "_new_unselected_item");
    ...
    OguiSlider *LoadSlider(const std::string &button_name, OguiWindow *window, int id)
    {
        ...
        // images
        std::string back_normal = getLocaleString(std::string(
                                                      "gui_") + window_name + "_" + button_name + "_back_normal");
        ...
        std::string back_disa = getLocaleString(std::string(
                                                    "gui_") + window_name + "_" + button_name + "_back_disabled");

        std::string fore_normal = getLocaleString(std::string(
                                                      "gui_") + window_name + "_" + button_name + "_fore_normal");
        ...
        std::string fore_disa = getLocaleString(std::string(
                                                    "gui_") + window_name + "_" + button_name + "_fore_disabled");
