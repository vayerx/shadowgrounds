...
namespace frozenbyte {
    namespace filesystem {
        ...
        {
            boost::scoped_ptr<InputCompressedFileStreamBufferData> tempData( new InputCompressedFileStreamBufferData(
                                                                                 fileName) );
            data.swap(tempData);
        }
        ...
        InputStream createInputCompressedFileStream(const std::string &fileName)
        {
            ...
            boost::shared_ptr<InputCompressedFileStreamBuffer> inputBuffer( new InputCompressedFileStreamBuffer(
                                                                                fileName) );
