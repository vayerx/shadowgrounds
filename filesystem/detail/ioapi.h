...
#if defined(USE_FILE32API) || _FILE_OFFSET_BITS == 64
...
#define ZREAD64(filefunc, filestream, buf, \
                size)        ( ( *( (filefunc).zfile_func64.zread_file ) )( (filefunc).zfile_func64.opaque, filestream, \
                                                                            buf, size ) )
#define ZWRITE64(filefunc, filestream, buf, \
                 size)       ( ( *( (filefunc).zfile_func64.zwrite_file ) )( (filefunc).zfile_func64.opaque, filestream, \
                                                                             buf, size ) )
