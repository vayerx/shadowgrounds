...
namespace frozenbyte {
    namespace filesystem {
        template <class Type> struct ConvertBase {
        ...
        template <class Type> struct ConvertFrom : private ConvertBase<Type>{
        ...
        template <class Type> struct ConvertTo : private ConvertBase<Type>{
            using ConvertBase<Type>::getSize;
