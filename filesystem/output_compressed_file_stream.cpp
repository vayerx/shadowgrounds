...
namespace frozenbyte {
    namespace filesystem {
        ...
        {
            boost::scoped_ptr<OutputCompressedFileStreamBufferData> tempData( new OutputCompressedFileStreamBufferData(
                                                                                  fileName) );
            data.swap(tempData);
        }
        ...
        OutputStream createOutputCompressedFileStream(const std::string &fileName)
        {
            ...
            boost::shared_ptr<OutputCompressedFileStreamBuffer> outputBuffer( new OutputCompressedFileStreamBuffer(
                                                                                  fileName) );
