                ...
                if (slen > 4 && strcmp(&filename[slen - 4], ".b3d") == 0) {
                    ...
                    if (hasObjectName) {
                        Logger::getInstance()->error(
                            "VisualObjectModel::getNewObjectInstance - Bonefilename cannot specify object.");
                        return NULL;
                    }
                    ...
                    if (hasObjectName) {
                        ...
                        for ( object_iterator = sharedModel->ITObject->Begin();
                              !object_iterator->IsEnd();
                        ...
                        if (!foundObject)
                            Logger::getInstance()->warning(
                                "VisualObjectModel::getNewObjectInstance - Model did not contain requested object.");
                    }
