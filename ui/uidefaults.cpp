 ...
 */
        ...
        frozenbyte::filesystem::FB_FILE *fp = frozenbyte::filesystem::fb_fopen("Data/Fonts/Unicode/small_blueish.fbf",
                                                                               "rb");
        ...
        OguiButtonStyle *closeStyle = new OguiButtonStyle(closeImage,
                                                          closeImageDown,
                                                          closeImageDis,
                                                          closeImage,
                                                          NULL,
        ...
        OguiSelectListStyle *sellistStyle = new OguiSelectListStyle(unselStyle,
                                                                    selStyle,
                                                                    upStyle,
                                                                    downStyle,
                                                                    800,
