        ...
        playerName("Pertti")
    {
        ...
        if (fromGame) {
            addButton(getLocaleGuiString(
                          "gui_mm_resume"),   COMMANDS_RESUME,    fonts->medium.normal, fonts->medium.highlighted);
            addSeparator();
        } else {
            continueButton = addButton(getLocaleGuiString(
                                           "gui_mm_continue"),        COMMANDS_CONTINUE,  fonts->medium.normal,
        ...
        addButton(getLocaleGuiString(
                      "gui_mm_new_game"),     COMMANDS_NEW_GAME,  fonts->medium.normal, fonts->medium.highlighted);
        addButton(getLocaleGuiString(
                      "gui_mm_load_game"),    COMMANDS_LOAD_GAME, fonts->medium.normal, fonts->medium.highlighted);
#ifdef PROJECT_SURVIVOR
        addButton(getLocaleGuiString(
                      "gui_mm_survival"), COMMANDS_SURVIVAL, fonts->medium.normal, fonts->medium.highlighted);
        addButton(getLocaleGuiString("gui_mm_coop"), COMMANDS_COOP, fonts->medium.normal, fonts->medium.highlighted);
#endif
        addButton(getLocaleGuiString(
                      "gui_mm_profiles"),     COMMANDS_PROFILES,  fonts->medium.normal, fonts->medium.highlighted);
        addButton(getLocaleGuiString(
                      "gui_mm_options"),      COMMANDS_OPTIONS,   fonts->medium.normal, fonts->medium.highlighted);
        addSeparator();
        addButton(getLocaleGuiString(
                      "gui_mm_credits"),      COMMANDS_CREDITS,   fonts->medium.normal, fonts->medium.highlighted);
        addButton(getLocaleGuiString(
                      "gui_mm_quit"),         COMMANDS_QUIT,      fonts->medium.normal, fonts->medium.highlighted);
    ...
    void MainMenu::abortCurrentGame()
    {
...

        {
            ...
            abortGameYes = ogui->CreateSimpleTextButton(captureAllEvents, x, y, w, h,
                                                        getLocaleGuiString(
                                                            "gui_mainmenu_abort_yes_norm"),
                                                        getLocaleGuiString("gui_mainmenu_abort_yes_down"),
                                                        getLocaleGuiString("gui_mainmenu_abort_yes_high"),
...

        {
            ...
            abortGameNo = ogui->CreateSimpleTextButton(captureAllEvents, x, y, w, h,
                                                       getLocaleGuiString(
                                                           "gui_mainmenu_abort_no_norm"),
                                                       getLocaleGuiString("gui_mainmenu_abort_no_down"),
                                                       getLocaleGuiString("gui_mainmenu_abort_no_high"),
...
//.............................................................................
    ...
    void MainMenu::addDifficultButton(int                x,
                                      int                y,
                                      int                w,
                                      int                h,
...
///////////////////////////////////////////////////////////////////////////////
    ...
    OguiButton *MainMenu::addButton(const std::string       &text,
                                    int                      command,
                                    IOguiFont               *font,
                                    IOguiFont               *high,
                                    IOguiFont               *down,
                                    ...
                                    OguiButton::TEXT_H_ALIGN halign)
    {
        ...
        if ( !text.empty() ) {
            ...
            if (getLocaleGuiInt( ( preHeader + "window_" + boost::lexical_cast< std::string >(count) ).c_str(),
                                 1 ) == 2)
                parent_win = win2;
