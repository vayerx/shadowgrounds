...
namespace ui
{
    UpgradeAvailableWindow::UpgradeAvailableWindow(Ogui *ogui, game::Game *game, int player)
    {
        ...
        this->win = ogui->CreateSimpleWindow(xPosition, yPosition, getLocaleGuiInt("gui_upgrade_available_size_x",
                                                                                   0),
                                             getLocaleGuiInt("gui_upgrade_available_size_y", 0), NULL);
        ...
        upgradeAvailableButton =
            ogui->CreateSimpleImageButton(win, 0, 0,
                                          getLocaleGuiInt("gui_upgrade_available_size_x",
                                                          0), getLocaleGuiInt("gui_upgrade_available_size_y",
                                                                              0), NULL,
                                          NULL, NULL);
