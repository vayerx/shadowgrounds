...
namespace ui
{
    ...
    void VisualEffect::moveBetween(const VC3 &position_,
    ...
    void VisualEffect::run()
    {
        if (follow != NULL)
            ...
            if ( this->effectType->getType() != VisualEffectType::VISUALEFFECT_TYPE_MUZZLEFLASH &&
                 muzzleAttachment.empty() )
    ...
    void VisualEffect::updateMuzzleAttachment(const std::string &name,
