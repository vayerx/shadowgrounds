...
///////////////////////////////////////////////////////////////////////////////
    ...
    {
        variableState = game->gameScripting->getGlobalIntVariableValue(
             (log_variable_state_prefix + watchVariable).c_str() );
    ...
    void LogEntry::setRead(bool read, Game *game)
    {
        if (read) {
            if (variableState != log_read) {
                ...
                if (game)
                    game->gameScripting->setGlobalIntVariableValue(
                         (log_variable_state_prefix + watchVariable).c_str(), log_read );
            }
        } else {
            if (variableState != log_not_read) {
                ...
                if (game)
                    game->gameScripting->setGlobalIntVariableValue(
                         (log_variable_state_prefix + watchVariable).c_str(), log_not_read );
            }
        }
    }
