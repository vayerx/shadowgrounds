...
#    else
        ...
        "\n"
#    endif
        "<b>based on SHADOWGROUNDS SURVIVOR for Linux</b>\n\nby\n"
        "\n"
        "<b>Tapio Honkonen</b>\n"
        "Company Management\n"
        "\n"
        ...
        "\n\n"
#    ifdef __APPLE__
        "Shadowgrounds for Mac, Copyright (c) 2011 Alternative Games Ltd.\n"
        "\n\n"
#    else
        "Shadowgrounds for Linux, Copyright (c) 2009 IGIOS Ltd.\n"
        "\n\n"
#    endif
#    ifdef WIN32
        "FMOD Sound System, copyright (c) Firelight Technologies Pty, Ltd., 1994-2005.\n"
...
///////////////////////////////////////////////////////////////////////////////
        ...
        speed(0.0f)
    {
        ...
        win =
            ogui->CreateSimpleWindow(getLocaleGuiInt("gui_creditsmenu_window_x",
                                                     0), getLocaleGuiInt("gui_creditsmenu_window_y", 0),
                                     getLocaleGuiInt("gui_creditsmenu_window_w",
                                                     1024), getLocaleGuiInt("gui_creditsmenu_window_h", 768), NULL);
...
//.............................................................................
    ...
    void CreditsMenu::update()
    {
        ...
        if (yPosition < -10000) {
            yPosition = 2000; hack = 2000;                    /*speed += speed;*/
        }
