    ...
    public:
            ...
            manager(manager)
        {
            ...
            effectWindow = new GUIEffectWindow( &ogui, getLocaleGuiString("gui_log_window_effect_layer1_image"),
                                                getLocaleGuiString(
                                                    "gui_log_window_effect_layer2_image"),
                                                getLocaleGuiString("gui_log_window_effect_layer3_image") );
        ...
        void init()
        {
...

            {
                ...
                textAreaBackground = ogui.CreateSimpleImageButton(window, x, y, w, h,
                                                                  NULL, NULL, NULL,
                                                                  getLocaleGuiString(
                                                                      "gui_log_text_area_background_image"), 0);
...

            {
                ...
                selectListBackground = ogui.CreateSimpleImageButton(window, x, y, w, h,
                                                                    NULL, NULL, NULL,
                                                                    getLocaleGuiString(
                                                                        "gui_log_selectlist_background_image"), 0);
...

            {
                ...
                exitButton = ogui.CreateSimpleTextButton( window, x, y, w, h,
                                                          getLocaleGuiString("gui_log_exit_image"),
                                                          getLocaleGuiString(
                                                              "gui_log_exit_image_down"), getLocaleGuiString(
                                                              "gui_log_exit_image_highlight"),
                                                          getLocaleGuiString("gui_map_exit") );
