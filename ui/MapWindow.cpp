...
namespace ui {
    ...
    struct MapWindow::Data : private IOguiButtonListener, private IOguiEffectListener {
        ...
        void init()
        {
            ...
            closeButton.reset( ogui.CreateSimpleTextButton(window.get(),
                                                           getLocaleGuiInt("gui_map_exit_position_x",
                                                                           0),
                                                           getLocaleGuiInt("gui_map_exit_position_y", 0),
                                                           getLocaleGuiInt("gui_map_exit_size_x",
                                                                           0), getLocaleGuiInt("gui_map_exit_size_y", 0),
                                                           getLocaleGuiString("gui_map_exit_image"),
                                                           getLocaleGuiString("gui_map_exit_image_down"),
...
#endif
            {
                ...
                mapBackground.reset( ogui.CreateSimpleTextButton(window.get(), mapBackgroundPosition.x,
                                                                 mapBackgroundPosition.y, xs, ys, fname, fname, fname,
                                                                 0) );
            }
            ...
            mapButton.reset( ogui.CreateSimpleTextButton(window.get(), mapPosition.x, mapPosition.y, mapSize.x,
                                                         mapSize.y, 0, 0, 0, 0) );
            ...
            playerButton.reset( ogui.CreateSimpleTextButton(window.get(), 0, 0, playerSize.x, playerSize.y,
                                                            getLocaleGuiString("gui_map_player_arrow_image"),
                                                            getLocaleGuiString("gui_map_player_arrow_image"),
                                                            getLocaleGuiString("gui_map_player_arrow_image_highlight"),
                                                            0, 0, 0, false) );
            ...
            checkpointButton.reset( ogui.CreateSimpleTextButton(window.get(), 0, 0, checkpointSize.x, checkpointSize.y,
                                                                getLocaleGuiString("gui_map_checkpoint_image"),
                                                                getLocaleGuiString("gui_map_checkpoint_image"),
                                                                getLocaleGuiString("gui_map_checkpoint_image_highlight"),
                                                                0, 0, 0, false) );
...
#ifdef PROJECT_SURVIVOR
            {
                ...
                mapOverlay.reset( ogui.CreateSimpleImageButton(window.get(), x, y, xs, ys, fname, fname, fname, fname,
                                                               0, 0, true) );
            ...
            }
            {
                ...
                int ys = getLocaleGuiInt("gui_map_primary_background_size_y", 0);
                const char *fname = getLocaleGuiString("gui_map_primary_background_image");
                primaryBackground.reset( ogui.CreateSimpleImageButton(window.get(), x, y, xs, ys, fname, fname, fname,
                                                                      fname, 0, 0, true) );
            ...
            }
            {
                ...
                const char *missiontitle = getLocaleGuiString( (std::string(
                                                                     game.getMissionId() ) + "_header_text").c_str() );
        ...
        void update(int ms)
        {
            ...
            if ( visible && mapButton.get() ) {
                ...
                mapButton->SetScroll(center_x - center_x / mapZoomFactor,
                                     center_y - center_y * mapAspectRatio / mapZoomFactor);
 ...
 */
        ...
        bool createObjectives()
        {
            for (int i = 0; i < 2; ++i) {
                ...
                int yLimit = 0;
                if (i == 0)
                    yLimit = getLocaleGuiInt("gui_map_primary_background_position_y", 0) + getLocaleGuiInt(
                        "gui_map_primary_background_size_y",
                        0);
                else
                    yLimit = getLocaleGuiInt("gui_map_secondary_background_position_y", 0) + getLocaleGuiInt(
                        "gui_map_secondary_background_size_y",
                        0);
                yLimit -= 10;
...
#endif
                {
                    ...
                    for (; it != list.end(); ++it) {
                        ...
                        if (i == 0 && it - list.begin() == currentObjective) {
                            ...
                            highlight.reset( ogui.CreateSimpleTextButton(window.get(), x, y, xs, ys, fname, fname,
                                                                         fname, 0) );
                        }
                        ...
                        shared_ptr<OguiCheckBox> checkbox( new OguiCheckBox(window.get(), &ogui, getLocaleGuiInt(
                                                                                ...
                                                                                0), getLocaleGuiInt(
                                                                                "gui_map_checkbox_size_y",
                                                                                0),
                                                                            getLocaleGuiString(
                                                                                "gui_map_checkbox_image"), "", "",
                                                                            getLocaleGuiString(
                                                                                "gui_map_checkbox_done_image"), "", "",
                                                                            0, it->completed, false) );
                        ...
                        text += it->id;
#endif
                        checkbox->setText(getLocaleGuiString(
                                               text.c_str() ), OguiCheckBox::TEXT_ALIGN_LEFT,
                                          getLocaleGuiInt("gui_map_primary_objects_label_size_x", 0), font);
            ...
            void updateButtons()
            {
                // Set player position
                {
                    ...
                    int yp =
                        int( (pos.y * mapZoomFactor / mapAspectRatio + mapPositionOffset.y) * mapSize.y ) + yOrigin;
                ...
                if ( currentObjective < int( objectives[0].size() ) ) {
                    ...
                    if ( it != objectivePoints.end() ) {
                        ...
                        checkpointButton->Resize( (int)(checkpointSize.x * mapZoomFactor),
                                                  (int)(checkpointSize.y * mapZoomFactor) );
        ...
        void MapWindow::addPortal(const std::string &fromLayer,
                                  const std::string &toLayer,
                                  const VC3         &fromPosition,
                                  const VC3         &toPosition)
        {
            Portal portal;
        ...
        void MapWindow::removePortal(const std::string & /*fromLayer*/,
                                     const std::string & /*toLayer*/,
                                     const      VC3 & /*fromPosition*/,
                                     const      VC3 & /*toPosition*/)
        {
