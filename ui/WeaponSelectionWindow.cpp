...
namespace ui
{
                                                 ...
                                                 int cornerNumber, int weaponsMask)
    {
        ...
        win = ogui->CreateSimpleWindow(x,
                                       y,
                                       WEAPSELECT_WINDOW_SIZE,
                                       WEAPSELECT_WINDOW_SIZE,
                                       "Data/GUI/Windows/weaponselection.tga");
        ...
        for (int i = 0; i < WEAPONSELECTIONWINDOW_MAX_WEAPONS; i++) {
            if ( ( weaponsMask & (1 << i) ) != 0 ) {
                ...
                weaponButtons[i] = ogui->CreateSimpleImageButton(win,
                                                                 x,
                                                                 y,
                                                                 WEAPSELECT_SELECTION_SIZE,
                                                                 WEAPSELECT_SELECTION_SIZE,
                                                                 NULL,
                                                                 NULL,
                                                                 NULL);
    ...
    void WeaponSelectionWindow::setSelectedWeapon(int selectionNumber)
    {
        ...
        if (selectionNumber == -1) {
            ...
            if (weaponButtons[selectionNumber] != NULL) {
                if (selection == NULL) {
                    selection = ogui->CreateSimpleImageButton(win,
                                                              0,
                                                              0,
                                                              WEAPSELECT_SELECTION_SIZE,
                                                              WEAPSELECT_SELECTION_SIZE,
