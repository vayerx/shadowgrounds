...
namespace ui {
    ...
    protected:
        ...
        virtual OguiButton *addButton(const std::string       &text,
                                      int                      command,
                                      IOguiFont               *font = NULL,
                                      IOguiFont               *high = NULL,
                                      IOguiFont               *down = NULL,
                                      IOguiFont               *disa = NULL,
                                      OguiButton::TEXT_H_ALIGN halign = OguiButton::TEXT_H_ALIGN_CENTER);
        virtual OguiButton *addDescription(const std::string &text, int x_add, int y_add, IOguiFont *font = NULL);
        virtual OguiButton *addSmallButton(const std::string &text,
                                           int                command,
                                           IOguiFont         *font = NULL,
                                           IOguiFont         *high = NULL,
                                           IOguiFont         *down = NULL,
        ...
        virtual OguiButton *addImageButtton(const std::string &image_norm,
        ...
        virtual void addSelectionButton(const std::string &text,
                                        int                command,
                                        IOguiFont         *font = NULL,
                                        void              *param = NULL);
        ...
        virtual void editButton(OguiButton        *button,
                                const std::string &defaultstring = "",
                                const std::string &before_the_input = "");
