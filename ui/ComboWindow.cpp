...
///////////////////////////////////////////////////////////////////////////////
    ...
    public:
        ...
        void onCombo()
        {
            ...
            comboMessageLength =
                (game::SimpleOptions::getInt(DH_OPT_I_GAME_COMBO_SHOWN_ON_SCREEN_TIME) / GAME_TICK_MSEC);
            ...
            if (comboCount > 1) {
                std::string combo;
                {
                    std::string temp = std::string("gui_combowindow_text_combo_") + boost::lexical_cast< std::string >(
                        comboCount);
