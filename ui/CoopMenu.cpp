...
///////////////////////////////////////////////////////////////////////////////
        ...
        optionsBigText(NULL)
    {
        ...
        ogui = o_gui;
        win =
            ogui->CreateSimpleWindow(getLocaleGuiInt("gui_coopmenu_window_x",
                                                     0), getLocaleGuiInt("gui_coopmenu_window_y", 0),
                                     getLocaleGuiInt("gui_coopmenu_window_w",
                                                     1024), getLocaleGuiInt("gui_coopmenu_window_h", 768), NULL);
        win->Hide();
        win->SetUnmovable();
        ...
        ///////////////////////////////////////////////////////////////////////////
        {
            startGame = ogui->CreateSimpleTextButton(win,  getLocaleGuiInt("gui_coopmenu_startgame_x",
                                                                           0),
                                                     getLocaleGuiInt("gui_coopmenu_startgame_y", 0),
                                                     getLocaleGuiInt("gui_coopmenu_startgame_w",
                                                                     0), getLocaleGuiInt("gui_coopmenu_startgame_h", 0),
                                                     getLocaleGuiString(
                                                         "gui_coopmenu_startgame_norm"),
                                                     getLocaleGuiString("gui_coopmenu_startgame_high"),
                                                     getLocaleGuiString(
                                                         "gui_coopmenu_startgame_high"), NULL, COMMANDS_STARTGAME);
        ...
        {
            loadGame = ogui->CreateSimpleTextButton(win,   getLocaleGuiInt("gui_coopmenu_loadgame_x",
                                                                           0),
                                                    getLocaleGuiInt("gui_coopmenu_loadgame_y", 0),
                                                    getLocaleGuiInt("gui_coopmenu_loadgame_w",
                                                                    0), getLocaleGuiInt("gui_coopmenu_loadgame_h", 0),
                                                    getLocaleGuiString(
                                                        "gui_coopmenu_loadgame_norm"),
                                                    getLocaleGuiString("gui_coopmenu_loadgame_high"),
                                                    getLocaleGuiString(
                                                        "gui_coopmenu_loadgame_high"), NULL, COMMANDS_LOADGAME);
        ...
        {
            startSurvival = ogui->CreateSimpleTextButton(win,  getLocaleGuiInt("gui_coopmenu_startsurvival_x",
                                                                               0),
                                                         getLocaleGuiInt("gui_coopmenu_startsurvival_y", 0),
                                                         getLocaleGuiInt("gui_coopmenu_startsurvival_w",
                                                                         0),
                                                         getLocaleGuiInt("gui_coopmenu_startsurvival_h", 0),
                                                         getLocaleGuiString(
                                                             "gui_coopmenu_startsurvival_norm"), getLocaleGuiString(
                                                             "gui_coopmenu_startsurvival_high"), getLocaleGuiString(
                                                             "gui_coopmenu_startsurvival_high"), NULL,
        ...
        options.resize(NUM_OPTIONS);
        {
            ...
            options[i]->setText(
                text.c_str(), OguiCheckBox::TEXT_ALIGN_RIGHT, 300, fonts->medium.highlighted,
...
///////////////////////////////////////////////////////////////////////////////
    ...
    void CoopMenu::createCooperativeMenu()
    {
        ...
        optionsButtons[0] = addButton("",
                                      COMMANDS_PLAYER1_OPTIONS,
                                      fonts->medium.normal,
                                      fonts->medium.highlighted,
                                      fonts->medium.down);
        optionsButtons[1] = addButton("",
                                      COMMANDS_PLAYER2_OPTIONS,
                                      fonts->medium.normal,
                                      fonts->medium.highlighted,
                                      fonts->medium.down);
        optionsButtons[2] = addButton("",
                                      COMMANDS_PLAYER3_OPTIONS,
                                      fonts->medium.normal,
                                      fonts->medium.highlighted,
                                      fonts->medium.down);
        optionsButtons[3] = addButton("",
...
//=============================================================================
    ...
    {
        coopCaptureEvents = ogui->CreateSimpleImageButton(win, 0, 0, getLocaleGuiInt("gui_coopmenu_window_w",
                                                                                     1024),
                                                          getLocaleGuiInt("gui_coopmenu_window_h",
