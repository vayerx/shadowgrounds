...
public:
    ...
    void createPhysics(game::GamePhysics *gamePhysics,
                       unsigned char     *clipMap,
                       bool               sleepPhysicsObjects,
                       const char        *currentMap);
    void updatePhysics(game::GamePhysics            *gamePhysics,
    ...
    void BlastHoleCircle(const VC3                    &position,
                         const VC3                    &direction,
                         float                         radius,
                         float                         depth,
                         std::vector<TerrainObstacle> &removedObjects);
    void BlastHoleSphere(const VC3                    &position,
                         const VC3                    &direction,
                         float                         radius,
                         float                         depth,
                         std::vector<TerrainObstacle> &removedObjects);
    //void BlendDamage(const Vector2D &position, float radius, int max_change, int max_value);
    void BlastTerrainObjects(const VC3                    &position,
                             float                         radius,
                             std::vector<TerrainObstacle> &removedObjects,
                             float                         blastHeight);
    void BreakTerrainObjects(const VC3                    &position,
                             const VC3                    &velocity,
                             float                         radius,
                             std::vector<TerrainObstacle> &removedObjects,
    ...
    void BreakTerrainObject(UnifiedHandle                 uh,
                            std::vector<TerrainObstacle> &removedObjects,
                            std::vector<ExplosionEvent>  &events,
                            int                           damage,
                            bool                          only_breaktexture);
    ...
    void unifiedHandleToTerrainIds(UnifiedHandle unifiedHandle, int *terrainModelIdOut,
                                   int *terrainObstacleIdOut) const;
    ...
    virtual game::tracking::ITrackableUnifiedHandleObjectIterator *getTrackableUnifiedHandleObjectsFromArea(
        const VC3                &position,
        float                     radius,
    ...
    void updateOcclusionForObject(util::GridOcclusionCuller   *culler,
                                  int                          terrainModelId,
