...
namespace ui
{
    StorageWindow::StorageWindow(Ogui *ogui, game::Game *game, int player)
    {
        ...
        partTypeSelectStyle = new OguiButtonStyle(partTypeSelectImage,
                                                  partTypeSelectActiveImage,
                                                  partTypeSelectDisabledImage,
                                                  partTypeSelectImage,
                                                  defaultFont,
                                                  116,
                                                  80);
        ...
        levelUnselStyle = new OguiButtonStyle(levelUnselectedImage,
                                              levelDownImage,
                                              NULL,
                                              levelUnselectedImage,
                                              defaultFont,
                                              160,
                                              20);
        levelSelStyle = new OguiButtonStyle(levelSelectedImage,
                                            levelSelectedDownImage,
                                            NULL,
                                            levelSelectedImage,
                                            defaultFont,
                                            160,
        ...
        levelStyle = new OguiSelectListStyle(levelUnselStyle,
                                             levelSelStyle,
                                             invisibleStyle,
                                             invisibleStyle,
                                             160,
        ...
        storageAmountStyle = new OguiSelectListStyle(numUnselStyle,
                                                     numUnselStyle,
                                                     invisibleStyle,
                                                     invisibleStyle,
                                                     100,
                                                     ...
                                                     0,
                                                     0);
        buyPriceStyle = new OguiSelectListStyle(numUnselStyle,
                                                numUnselStyle,
                                                invisibleStyle,
                                                invisibleStyle,
                                                100,
                                                ...
                                                0,
                                                0);
        sellPriceStyle = new OguiSelectListStyle(numUnselStyle,
                                                 numUnselStyle,
                                                 defaultUpButton,
                                                 defaultDownButton,
                                                 116,
