...
namespace ui
{
                                               ...
                                               int player)
    {
        ...
        purchaseButtonStyle = new OguiButtonStyle(purchaseButtonImage,
                                                  purchaseButtonDownImage,
                                                  purchaseButtonDisabledImage,
                                                  purchaseButtonHighlightedImage,
                                                  defaultFont,
                                                  170,
                                                  20);
        ...
        unitSelectStyle = new OguiButtonStyle(unitSelectImage,
                                              unitSelectActiveImage,
                                              unitSelectDisabledImage,
                                              unitSelectImage,
                                              defaultThinWhiteFont,
                                              94,
                                              29);
        unitSelectActiveStyle = new OguiButtonStyle(unitSelectActiveImage,
                                                    unitSelectActiveImage,
                                                    unitSelectDisabledImage,
                                                    unitSelectActiveImage,
                                                    defaultThinWhiteFont,
    ...
    void ArmorConstructWindow::addPartButton(Part *p, Part *pp, int slotNumber, int x, int y)
    {
        ...
        if (p != NULL) {
            ...
            if (slotSize == 1) {
                ...
                if (slotSize == 2)
                    b2 = ogui->CreateSimpleTextButton(win,
                                                      x - 40,
                                                      y - 80,
                                                      80,
                                                      160,
