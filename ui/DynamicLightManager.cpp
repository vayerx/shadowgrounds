...
namespace ui {
    ...
    UnifiedHandle DynamicLightManager::getUnifiedHandle(int typeId, int instanceId) const
    {
        ...
        assert( IS_UNIFIED_HANDLE_DYNAMIC_LIGHT( ( UNIFIED_HANDLE_BIT_DYNAMIC_LIGHT | typeId
                                                   | (instanceId << UNIFIED_HANDLE_DYNAMIC_LIGHT_INSTANCE_ID_SHIFT) ) ) );

        return ( UNIFIED_HANDLE_BIT_DYNAMIC_LIGHT | typeId
                 | (instanceId << UNIFIED_HANDLE_DYNAMIC_LIGHT_INSTANCE_ID_SHIFT) );
    }
    ...
    void DynamicLightManager::unifiedHandleToLightIds(UnifiedHandle unifiedHandle, int &typeId, int &instanceId) const
    {
        ...
        typeId =
            ( (unifiedHandle & UNIFIED_HANDLE_DYNAMIC_LIGHT_TYPE_ID_MASK) >> UNIFIED_HANDLE_DYNAMIC_LIGHT_TYPE_ID_SHIFT );
        instanceId =
            ( (unifiedHandle
               & UNIFIED_HANDLE_DYNAMIC_LIGHT_INSTANCE_ID_MASK) >> UNIFIED_HANDLE_DYNAMIC_LIGHT_INSTANCE_ID_SHIFT );
