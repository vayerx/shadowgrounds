...
namespace ui
{
        ...
        locked_font(NULL)
    {
        ...
        ogui = o_gui;
        win =
            ogui->CreateSimpleWindow(getLocaleGuiInt("gui_survivalmenu_window_x",
                                                     0), getLocaleGuiInt("gui_survivalmenu_window_y",
                                                                         0),
                                     getLocaleGuiInt("gui_survivalmenu_window_w",
                                                     1024),
                                     getLocaleGuiInt("gui_survivalmenu_window_h", 768), NULL);
        win->Hide();
        win->SetUnmovable();
        ...
        buttonAddX =
            getLocaleGuiInt( "gui_survivalmenu_button_add_x", getLocaleGuiInt("gui_menu_common_button_add_x", 0) );
        buttonAddY =
            getLocaleGuiInt( "gui_survivalmenu_button_add_y", getLocaleGuiInt("gui_menu_common_button_add_y", 28) );
        ...
        //
        {
            ...
            b = ogui->CreateSimpleTextButton(win, x, y, w, h,
                                             imageCrap.c_str(), imageCrap.c_str(), imageCrap.c_str(),
                                             buttonText.c_str(), COMMANDS_LOAD);
            b->SetListener(this);
        ...
        showCustomMissions->setText(getLocaleGuiString(
                                        "gui_survivalmenu_showcustom_text"), OguiCheckBox::TEXT_ALIGN_LEFT,
                                    getLocaleGuiInt("gui_survivalmenu_showcustom_textwidth",
                                                    200), fonts->little.highlighted);
            ...
            if ( GameStats::getScoreLimits(dirname.c_str(), developer, ultimate) )
                for (unsigned int i = 0; i < mi.scoreNumbers.size(); i++) {
                    if (mi.scoreNumbers[i] > ultimate) {
                        ...
                        int y = getLocaleGuiInt("gui_survivalmenu_ultimatestar_y", 0) + scoreText->getLinePositionY(
                            2 + i * 3);
                        ...
                        OguiButton *but = ogui->CreateSimpleImageButton(win,
                                                                        x,
                                                                        y,
                                                                        w,
                                                                        h,
                        ...
                        int y = getLocaleGuiInt("gui_survivalmenu_developerstar_y", 0) + scoreText->getLinePositionY(
                            2 + i * 3);
...
//.............................................................................
    ...
    void SurvivalMenu::addImageSelectionButton(const std::string &image_norm,
                                               ...
                                               void              *param)
    {
        ...
        OguiButton *b;
        b = ogui->CreateSimpleTextButton(win, buttonX, buttonY, buttonW, buttonH, image_norm.c_str(),
                                         image_down.c_str(), image_high.c_str(), "", command, param, true);
        b->SetListener(this);
    ...
    bool SurvivalMenu::loadMissionInfo(const std::string &directory, MissionInfo &mi)
    {
        ...
        const char *locale_id =
            DHLocaleManager::getInstance()->getLocaleIdString( SimpleOptions::getInt(DH_OPT_I_MENU_LANGUAGE) );
    ...
    void SurvivalMenu::createMissionButtons()
    {
        ...
        for (unsigned int i = 0; i < numDirs; i++) {
            ...
            if ( std::find(lockedMissions.begin(), lockedMissions.end(), dirs[i]) != lockedMissions.end() ) {
                ...
                this->addImageSelectionButton(locked_img_norm,
                                              locked_img_high,
                                              locked_img_down,
                                              locked_img_down,
                                              false,
                ...
                if (selectButtons[ i + 1 ]) {
                    selectButtons[ i + 1 ]->SetSelectedImages( ogui->LoadOguiImage(
                                                                   locked_img_selected_norm),
                                                               ogui->LoadOguiImage(locked_img_selected_high) );
                ...
                this->addImageSelectionButton(missionInfos[i + 1].thumbnail_norm,
                                              missionInfos[i + 1].thumbnail_high,
                                              missionInfos[i + 1].thumbnail_down,
                                              missionInfos[i + 1].thumbnail_down,
                                              false,
                                              i + 1,
                                              NULL);
                ...
                if (selectButtons[ i + 1 ])
                    selectButtons[ i
                                   + 1 ]->SetSelectedImages( ogui->LoadOguiImage(
                                                                  missionInfos[i + 1].thumbnail_selected_norm.c_str() ),
                                                             ogui->LoadOguiImage( missionInfos[i
                                                                                               + 1].
                                                                                  thumbnail_selected_high.c_str() ) );
            }
...
//.............................................................................
    ...
    void SurvivalMenu::updateArrows()
    {
        ...
        if (scrollCount > 0 && scrollUpArrow == NULL) {
            ...
            scrollUpArrow = this->addImageButtton(image_norm,
                                                  image_down,
                                                  image_high,
                                                  image_disa,
                                                  COMMANDS_ARROWUP,
        ...
        if (scrollCount > 0 && scrollDownArrow == NULL) {
            ...
            scrollDownArrow = this->addImageButtton(image_norm,
                                                    image_down,
                                                    image_high,
                                                    image_disa,
                                                    COMMANDS_ARROWDOWN,
    ...
    bool SurvivalMenu::readLockedMissions(std::vector<std::string> &missions)
    {
        ...
        // open file
        frozenbyte::filesystem::FB_FILE *f =
            frozenbyte::filesystem::fb_fopen(igios_mapUserDataPrefix("Config/unlocked_missions.dat").c_str(), "rb");
        if (f != NULL) {
