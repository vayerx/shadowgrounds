...
namespace ui
{
    void DebugTerrainObjectVisualizer::visualizeTerrainObject(game::Game                *game,
                                                              ...
                                                              DebugTerrainObjectVisFlags visFlags)
    {
        ...
        VC3 c1 = pos
                 - (oobb.axes[0] * oobb.extents.x) + (oobb.axes[1] * oobb.extents.y) - (oobb.axes[2] * oobb.extents.z);
        VC3 c2 = pos
                 + (oobb.axes[0] * oobb.extents.x) + (oobb.axes[1] * oobb.extents.y) - (oobb.axes[2] * oobb.extents.z);
        VC3 c3 = pos
                 + (oobb.axes[0] * oobb.extents.x) + (oobb.axes[1] * oobb.extents.y) + (oobb.axes[2] * oobb.extents.z);
        ...
        if ( game::SimpleOptions::getBool(DH_OPT_B_DEBUG_VISUALIZE_TERRAINOBJECTS_EXTENDED)
             && distToCamSq <
             (DEBUGTERRAINOBJECTVISUALIZER_EXTENDED_MAX_DIST * DEBUGTERRAINOBJECTVISUALIZER_EXTENDED_MAX_DIST) )
        {
