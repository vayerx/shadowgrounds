 ...
 */
        ...
        bonusOptionWindow(NULL)
    {
        ...
        Logger::getInstance()->debug( ( (std::string)("LoadGameMenu - Mission amount ")
                                        + boost::lexical_cast< std::string >(mission_max) ).c_str() );

        game = g;

        ogui = o_gui;
        win =
            ogui->CreateSimpleWindow(getLocaleGuiInt("gui_loadgamemenu_window_x",
                                                     0), getLocaleGuiInt("gui_loadgamemenu_window_y",
                                                                         0),
                                     getLocaleGuiInt("gui_loadgamemenu_window_w",
                                                     1024),
                                     getLocaleGuiInt("gui_loadgamemenu_window_h", 768), NULL);
        win->Hide();
        win->SetUnmovable();
        ...
        buttonAddX =
            getLocaleGuiInt( "gui_loadgamemenu_button_add_x", getLocaleGuiInt("gui_menu_common_button_add_x", 0) );
        buttonAddY =
            getLocaleGuiInt( "gui_loadgamemenu_button_add_y", getLocaleGuiInt("gui_menu_common_button_add_y", 28) );
        ...
        if (survivor == false) {
            ...
            for (i = 1; i <= mission_max; i++) {
                ...
                if (add) {
                    ...
                    addButton(getLocaleGuiString(
                                  "gui_lgm_empty"), i, fonts->medium.normal, NULL, NULL, NULL,
                              OguiButton::TEXT_H_ALIGN_LEFT);
                }
            }
        }
        ///////////////////////////////////////////////////////////////////////////
            ...
            for (i = 1; i <= mission_max; i++) {
                ...
                if (add) {
                    std::string temp = std::string("gui_loadgamemenu_mission_")
                                       + boost::lexical_cast< std::string >(i) + "_image_norm";
                    const std::string image_norm = getLocaleGuiString( temp.c_str() );

                    temp = std::string("gui_loadgamemenu_mission_") + boost::lexical_cast< std::string >(i)
                           + "_image_high";
                    ...
                    if (selectButtons[ i ])
                        selectButtons[ i ]->SetSelectedImages( ogui->LoadOguiImage(
                                                                    image_selected_norm.c_str() ),
                                                               ogui->LoadOguiImage( image_selected_high.c_str() ) );
        ...
        if (survivor) {
            {
                ...
                buttonH = h;
                addButton(getLocaleGuiString(
                              "gui_lgm_load"), COMMANDS_LOAD, fonts->medium.normal, fonts->medium.highlighted,
                          fonts->medium.down,
                          fonts->medium.disabled, OguiButton::TEXT_H_ALIGN_LEFT);
            }
            ...
            if ( game->bonusManager->getNumOptions() > 0 && game->bonusManager->areOptionsAvailable() ) {
                ...
                buttonH = h;
                addButton(getLocaleGuiString(
                              "gui_lgm_bonusoptions"), COMMANDS_BONUSOPTIONS, fonts->medium.normal,
                          fonts->medium.highlighted,
                          fonts->medium.down, fonts->medium.disabled, OguiButton::TEXT_H_ALIGN_LEFT);
            }
#endif
            ...
            if (scrollCount > 0) {
                ...
                survivorInfoScreen->scrollUpArrow = this->addImageButtton(image_norm,
                                                                          image_down,
                                                                          image_high,
                                                                          image_disa,
                                                                          COMMANDS_ARROWUP,
            ...
            if (scrollCount > 0) {
                ...
                survivorInfoScreen->scrollDownArrow = this->addImageButtton(image_norm,
                                                                            image_down,
                                                                            image_high,
                                                                            image_disa,
                                                                            COMMANDS_ARROWDOWN,
            ...
            addSmallButton(getLocaleGuiString(
                               "gui_lgm_load"), COMMANDS_LOAD, fonts->medium.normal, fonts->medium.highlighted,
                           fonts->medium.down,
            ...
            if (eve->cursorOldButtonMask & OGUI_BUTTON_WHEEL_UP_MASK) {
                ...
                game->bonusManager->buttonPressed(eve->triggerButton->GetId() - COMMANDS_BONUSOPTION_BUTTONS);
                     ...
                     case COMMANDS_ARROWUP:
                         ...
                         break;
                     default: {
                         if (doubleClickHack == eve->triggerButton->GetId() &&
                             (Timer::getTime() - doubleClickTimeHack) < 500) {
                             menuLoad();
                         } else {
                             MenuBaseImpl::CursorEvent(eve);
...
///////////////////////////////////////////////////////////////////////////////
    ...
    void LoadGameMenu::addImageSelectionButton(const std::string &image_norm,
                                               ...
                                               void              *param)
    {
        ...
        OguiButton *b;
        b = ogui->CreateSimpleImageButton(win, buttonX, buttonY, buttonW, buttonH, image_norm.c_str(), image_down.c_str(
                                              ), image_high.c_str(), image_disabled.c_str(), command, param, true);
...
///////////////////////////////////////////////////////////////////////////////
    ...
    void LoadGameMenu::menuBonusOptions()
    {
        ...
        if (bonusOptionWindow == NULL) {
            bonusOptionWindow = ogui->CreateSimpleWindow(win->GetPositionX(), win->GetPositionY(),
                                                         win->GetSizeX(), win->GetSizeY(), NULL);
            ...
            NewGameMenu::createBonusOptions(game,
                                            bonusOptionWindow,
                                            ogui,
                                            fonts,
                                            bonusOptionBoxes,
            ...
            // apply button
            {
                ...
                OguiButton *but = ogui->CreateSimpleTextButton(bonusOptionWindow,
                                                               x,
                                                               y,
                                                               w,
                                                               h,
                                                               ...
                                                               "",
                                                               "",
                                                               getLocaleGuiString("gui_lgm_applybonusoptions"),
                ...
                if (COMMANDS_APPLYBONUSOPTIONS > numberOfWorkingSelectButtons) numberOfWorkingSelectButtons =
                        COMMANDS_APPLYBONUSOPTIONS;
