...
namespace ui {
    ...
    Terrain *TerrainCreator::createTerrain(game::GameMap           *gameMap,
                                           ...
                                           const char              *configFile)
    {
        ...
        Terrain *terrain = new Terrain(storm3d, scene, configFile, forceMapName.c_str(),
                                       gameMap->getAreaMap(), gameMap, lightManager, ambientSoundManager);
