...
namespace ui
{
    ...
    void LoadingMessage::renderLoadingMessage()
    {
        ...
        if (loading_bar_value != -1) {
            ...
            bar_bg =
                ogui->CreateSimpleImageButton(win, x, y, w, h, game::getLocaleGuiString(
                                                  "gui_loadingbar_background"), NULL, NULL, 0);

            bar =
                ogui->CreateSimpleImageButton(win, x, y, loading_bar_value * w / 100, h, game::getLocaleGuiString(
                                                  "gui_loadingbar_foreground"), NULL, NULL, 0);
        ...
        if (scene->ITTerrain) {
            ...
            while ( !it.IsEnd() ) {
                ...
                oldValues.push_back( terrain->getRenderer().enableFeature(IStorm3D_TerrainRenderer::RenderTargets,
                                                                          false) );
                it.Next();
            }
        }
