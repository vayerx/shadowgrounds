...
namespace ui {
    ...
    public:
        ...
        void setActive(IngameGuiTabs::IngameWindows current_active)
        {
            ...
            if ( currentActive >= 0 && currentActive < (int)buttons.size() )
                if (buttons[ currentActive ] != NULL) {
                    ...
                    buttons[ currentActive ] = loadButton(buttonsUp[ currentActive ],
                                                          (GameUI::WINDOW_TYPE)currentActive);
                }
        ...
        void init()
        {
            ...
            buttons[ GameUI::WINDOW_TYPE_LOG ]      = loadButton(buttonsUp[ GameUI::WINDOW_TYPE_LOG ],
                                                                 GameUI::WINDOW_TYPE_LOG);
#endif

            buttons[ GameUI::WINDOW_TYPE_UPGRADE ]  = loadButton(buttonsUp[ GameUI::WINDOW_TYPE_UPGRADE ],
                                                                 GameUI::WINDOW_TYPE_UPGRADE);
            buttons[ GameUI::WINDOW_TYPE_MAP ]      = loadButton(buttonsUp[ GameUI::WINDOW_TYPE_MAP ],
                                                                 GameUI::WINDOW_TYPE_MAP);
        ...
        OguiButton *loadButton(const std::string &name, int id = 0)
        {
            ...
            OguiButton *result;
            result = ogui->CreateSimpleTextButton(window, x, y, w, h, norm.c_str(), down.c_str(),
                                                  high.c_str(), text.c_str(), id, NULL);
            result->SetFont(font);
