...
//        win = ogui->CreateSimpleWindow(1024-256, 768-128-16-40, 256, 120, NULL);
        ...
        // difficulty label
        difficultyTextLabel =
            ogui->CreateTextLabel( win, 0, 3 * 20, 64, 18, getLocaleGuiString("gui_options_difficulty") );
        ...
        b = ogui->CreateSimpleTextButton(win,
                                         ...
                                         96,
                                         20,
                                         "Data/GUI/Buttons/playercontroller.tga",
                                         "Data/GUI/Buttons/playercontroller_down.tga",
                                         "Data/GUI/Buttons/playercontroller_highlight.tga",
                                         "",
                                         OPTIONSW_DIFFICULTY_LEVEL);
        b->SetReactMask(OGUI_REACT_MASK_OVER | OGUI_REACT_MASK_BUT_1);
        b->SetListener(this);
        b->SetEventMask(OGUI_EMASK_CLICK);
        b->SetFont(ui::defaultMediumIngameFont);
