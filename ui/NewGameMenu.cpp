...
// Converts player number into a running number
    ...
    void setSinglePlayer(const Game *game)
    {
        ...
        SimpleOptions::setInt( DH_OPT_I_1ST_PLAYER_CONTROL_SCHEME, game->getGameUI()->getController(
                                   0)->getControllerType() );
...
///////////////////////////////////////////////////////////////////////////////
        ...
        startGame(NULL)
    {
        ...
        ogui = o_gui;
        win =
            ogui->CreateSimpleWindow(getLocaleGuiInt("gui_newgamemenu_window_x",
                                                     0), getLocaleGuiInt("gui_newgamemenu_window_y", 0),
                                     getLocaleGuiInt("gui_newgamemenu_window_w",
                                                     1024), getLocaleGuiInt("gui_newgamemenu_window_h", 768), NULL);
        win->Hide();
        win->SetUnmovable();
        ...
        if ( DHLocaleManager::getInstance()->hasString(DHLocaleManager::BANK_GUI,
            ...
            difficultToolTips.insert( std::pair<int, std::string>( COMMANDS_EASY,
                                                                   getLocaleGuiString(
                                                                       "gui_newgamemenu_text_tooltip_easy") ) );
            difficultToolTips.insert( std::pair<int, std::string>( COMMANDS_NORMAL,
                                                                   getLocaleGuiString(
                                                                       "gui_newgamemenu_text_tooltip_normal") ) );
            difficultToolTips.insert( std::pair<int, std::string>( COMMANDS_HARD,
                                                                   getLocaleGuiString(
                                                                       "gui_newgamemenu_text_tooltip_hard") ) );
            difficultToolTips.insert( std::pair<int, std::string>( COMMANDS_VERY_HARD,
                                                                   getLocaleGuiString(
                                                                       "gui_newgamemenu_text_tooltip_very_hard") ) );
            difficultToolTips.insert( std::pair<int, std::string>( COMMANDS_EXTREMELY_HARD,
                                                                   getLocaleGuiString(
                                                                       "gui_newgamemenu_text_tooltip_extremely_hard") ) );
            difficultToolTipText = ogui->CreateTextArea(win,
                                                        difficultToolTipX,
                                                        difficultToolTipY,
                                                        difficultToolTipW,
                                                        difficultToolTipH,
        ...
        ///////////////////////////////////////////////////////////////////////////
        {
            startGame = ogui->CreateSimpleTextButton(win,  getLocaleGuiInt("gui_newgamemenu_startgame_x",
                                                                           0),
                                                     getLocaleGuiInt("gui_newgamemenu_startgame_y", 0),
                                                     getLocaleGuiInt("gui_newgamemenu_startgame_w",
                                                                     0),
                                                     getLocaleGuiInt("gui_newgamemenu_startgame_h", 0),
                                                     getLocaleGuiString(
                                                         "gui_newgamemenu_startgame_norm"),
                                                     getLocaleGuiString("gui_newgamemenu_startgame_high"),
                                                     getLocaleGuiString(
                                                         "gui_newgamemenu_startgame_high"), NULL, COMMANDS_STARTGAME);
...
#ifdef PROJECT_SURVIVOR
        {
            ...
            tutorialHintsButton->setText(text,
                                         OguiCheckBox::TEXT_ALIGN_RIGHT,
                                         text_w,
                                         fonts->medium.highlighted,
                                         OguiButton::TEXT_V_ALIGN_TOP);
...
///////////////////////////////////////////////////////////////////////////////
    ...
    void NewGameMenu::createDifficultyButtons()
    {
        ...
        addDifficultButton(difficultButtonX,
                           difficultButtonY,
                           difficultButtonW,
                           difficultButtonH,
                           optionsDifficultButtonNormal,
                           optionsDifficultButtonDown,
                           optionsDifficultButtonHigh,
                           fonts->medium.normal,
                           fonts->medium.highlighted,
                           fonts->medium.down,
        ...
        if (veryHardAvail) {
            ...
            addDifficultButton(difficultButtonX,
                               difficultButtonY,
                               difficultButtonLine2W,
                               difficultButtonLine2H,
                               optionsDifficultButtonNormal,
                               optionsDifficultButtonDown,
                               optionsDifficultButtonHigh,
                               fonts->medium.normal,
        ...
        else if (diff >= VERY_HARD_VALUE && diff < EXTREMELY_HARD_VALUE && veryHardAvail) selectDifficultButton(
                COMMANDS_VERY_HARD);
...
//.............................................................................
    ...
    void NewGameMenu::addDifficultButton(int                x,
                                         int                y,
                                         int                w,
                                         int                h,
...
//.............................................................................
    ...
    void NewGameMenu::addGameModeButton(int                x,
                                        int                y,
                                        int                w,
                                        int                h,
                                        const std::string &button_norm,
...
//=============================================================================
    ...
    {
        coopCaptureEvents = ogui->CreateSimpleImageButton(win, 0, 0, getLocaleGuiInt("gui_newgamemenu_window_w",
                                                                                     1024),
                                                          getLocaleGuiInt("gui_newgamemenu_window_h",
        ...
        if (selectListStyle == NULL) {
            ...
            scroll_button_w = scrollUpStyle->sizeX >
                              scrollDownStyle->sizeX ? scrollUpStyle->sizeX : scrollDownStyle->sizeX;
        ...
        {
            const std::string &current_player = coopPlayerNames.find(i) !=
                                                coopPlayerNames.end() ? coopPlayerNames[ i ] : none;
...
//.............................................................................
    ...
    void NewGameMenu::createBonusOptions(game::Game                  *game,
                                         OguiWindow                  *win,
                                         Ogui                        *ogui,
                                         MenuCollection::Fonts       *fonts,
                                         std::vector<OguiCheckBox *> &boxes,
                                         std::vector<OguiButton *>   &buttons,
                                         std::list<OguiTextLabel *>  &texts,
                                         IOguiButtonListener         *button_listener,
                                         int                          button_id_offset,
                                         int                          offset_x,
                                         int                          offset_y)
    {
#ifdef PROJECT_SURVIVOR
        ...
        if (numOptions == 0) {
            ...
            for (int i = 0; i < numOptions; i++) {
                ...
                if ( game->bonusManager->shouldCreateAsButton(i) ) {
                    OguiButton *b;
                    b = ogui->CreateSimpleTextButton(win,
                                                     x + w,
                                                     y + 1,
                                                     text_w,
                                                     h,
                    ...
                    b->setText(
                        text.c_str(), OguiCheckBox::TEXT_ALIGN_RIGHT, text_w, fonts->medium.highlighted,
                        OguiButton::TEXT_V_ALIGN_TOP);
