...
// this is because keyb3 seems to give them inverted, so we fix that here.
    const char *keycodeName[KEYCODE_NAME_AMOUNT] = {
        ...
        "wheel-down", "wheel-up", "button-1", "button-2", "button-3", "button-4", "button-5", "button-6", "button-7",
        "button-8",
        "joy-up", "joy-down", "joy-left", "joy-right", "joy-but-1", "joy-but-2", "joy-but-3", "joy-but-4", "joy-but-5",
        "joy-but-6",
        "joy-but-7", "joy-but-8", "joy-but-9", "joy-but-10", "joy-but-11", "joy-but-12", "joy-but-13", "joy-but-14",
        "joy-but-15", "joy-but-16",
        "joy2-up", "joy2-down", "joy2-left", "joy2-right", "joy2-but-1", "joy2-but-2", "joy2-but-3", "joy2-but-4",
        "joy2-but-5", "joy2-but-6",
        "joy2-but-7", "joy2-but-8", "joy2-but-9", "joy2-but-10", "joy2-but-11", "joy2-but-12", "joy2-but-13",
        "joy2-but-14", "joy2-but-15", "joy2-but-16",
        "joy-rot-up", "joy-rot-down", "joy-rot-left", "joy-rot-right", "joy-throttle-up", "joy-throttle-down",
        "joy-rudder-left", "joy-rudder-right",
        "joy2-rot-up", "joy2-rot-down", "joy2-rot-left", "joy2-rot-right", "joy2-throttle-up", "joy2-throttle-down",
        "joy2-rudder-left", "joy2-rudder-right",

        "joy3-rot-up", "joy3-rot-down", "joy3-rot-left", "joy3-rot-right", "joy3-throttle-up", "joy3-throttle-down",
        "joy3-rudder-left", "joy3-rudder-right",
        "joy4-rot-up", "joy4-rot-down", "joy4-rot-left", "joy4-rot-right", "joy4-throttle-up", "joy4-throttle-down",
        "joy4-rudder-left", "joy4-rudder-right",

        "joy3-up",      "joy3-down",    "joy3-left", "joy3-right", "joy3-but-1", "joy3-but-2", "joy3-but-3",
        "joy3-but-4",          "joy3-but-5",   "joy3-but-6",
        "joy3-but-7",   "joy3-but-8",   "joy3-but-9", "joy3-but-10", "joy3-but-11", "joy3-but-12", "joy3-but-13",
        "joy3-but-14",    "joy3-but-15",  "joy3-but-16",
        "joy4-up",      "joy4-down",    "joy4-left", "joy4-right", "joy4-but-1", "joy4-but-2", "joy4-but-3",
        "joy4-but-4",          "joy4-but-5",   "joy4-but-6",
        "joy4-but-7",   "joy4-but-8",   "joy4-but-9", "joy4-but-10", "joy4-but-11", "joy4-but-12", "joy4-but-13",
        "joy4-but-14",    "joy4-but-15",  "joy4-but-16",

        "", "", "", "", "", "", "", "",
        "", "", "", "", "", "", "", "", "", "",

        "mouse0-up", "mouse0-down", "mouse0-left", "mouse0-right", "wheel0-down", "wheel0-up", "button0-8", "button0-7",
        "button0-6", "button0-5",
        "button0-4", "button0-3", "button0-2", "button0-1", "", "", "", "", "", "",

        "mouse1-up", "mouse1-down", "mouse1-left", "mouse1-right", "wheel1-down", "wheel1-up", "button1-8", "button1-7",
        "button1-6", "button1-5",
        "button1-4", "button1-3", "button1-2", "button1-1", "", "", "", "", "", "",

        "mouse2-up", "mouse2-down", "mouse2-left", "mouse2-right", "wheel2-down", "wheel2-up", "button2-8", "button2-7",
        "button2-6", "button2-5",
        "button2-4", "button2-3", "button2-2", "button2-1", "", "", "", "", "", "",

        "mouse3-up", "mouse3-down", "mouse3-left", "mouse3-right", "wheel3-down", "wheel3-up", "button3-8", "button3-7",
        "button3-6", "button3-5",
        "button3-4", "button3-3", "button3-2", "button3-1", "", "", "", "", "", "",

        "mouse4-up", "mouse4-down", "mouse4-left", "mouse4-right", "wheel4-down", "wheel4-up", "button4-8", "button4-7",
        "button4-6", "button4-5",
        "button4-4", "button4-3", "button4-2", "button4-1", "", "", "", "", "", "",

        "mouse5-up", "mouse5-down", "mouse5-left", "mouse5-right", "wheel5-down", "wheel5-up", "button5-8", "button5-7",
        "button5-6", "button5-5",
        "button5-4", "button5-3", "button5-2", "button5-1", "", "", "", "", "", "",

        "mouse6-up", "mouse6-down", "mouse6-left", "mouse6-right", "wheel6-down", "wheel6-up", "button6-8", "button6-7",
        "button6-6", "button6-5",
...
///////////////////////////////////////////////////////////////////////////////
    ...
    GameController::JOYSTICK_AXIS convertToEnum(const std::string &value)
    {
        ...
        Logger::getInstance()->warning(
             ("GameController::convertToEnum  and unidentified joystick axis: " + value).c_str() );
 ...
 */
    ...
    int GameController::addKeyreader(IGameControllerKeyreader *keyreader)
    {
        if (keyreaderStack[GAMECONTROLLER_MAX_KEYREADERS - 1] != NULL)
            Logger::getInstance()->error(
                "GameController::addKeyreader - Too many keyreaders (oldest keyreader information dropped).");
        ...
        if (keyreader != NULL) {
            ...
            while (readKeyReadPos != readKeyWritePos) {
                ...
                if (failcount > GAMECONTROLLER_KEYREADER_BUFFER_SIZE) {
                    ...
                    Logger::getInstance()->error(
                        "GameController::run - Internal error while iterating keyreader buffer.");
                    break;
                }
            }
    ...
    inline bool convertJoystickKey(int                            &key,
                                   GameController::CONTROLLER_TYPE type_new,
                                   GameController::CONTROLLER_TYPE type_old)
    {
        // no conversion
        if (type_old < GameController::CONTROLLER_TYPE_JOYSTICK1 || type_old >
            GameController::CONTROLLER_TYPE_JOYSTICK4)
            return false;

        // no conversion
        if (type_new < GameController::CONTROLLER_TYPE_JOYSTICK1 || type_new >
            GameController::CONTROLLER_TYPE_JOYSTICK4)
            return false;
    ...
    inline bool convertMouseKey(int                            &key,
                                GameController::CONTROLLER_TYPE type_new,
                                GameController::CONTROLLER_TYPE type_old)
    {
        ...
        // no conversion
        if (type_new < GameController::CONTROLLER_TYPE_KEYBOARD_AND_MOUSE1 || type_new >
...
// returns the type of the controller
    ...
    {
        return controllerType >= CONTROLLER_TYPE_KEYBOARD_AND_MOUSE1 && controllerType <=
               CONTROLLER_TYPE_KEYBOARD_AND_MOUSE4;
    }
