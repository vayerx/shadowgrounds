...
namespace ui
{
        ...
        profileInfoText(NULL)
    {
        ...
        addSmallButton(getLocaleGuiString(
                           "gui_pm_select"), COMMANDS_SELECT, fonts->medium.normal, fonts->medium.highlighted,
                       fonts->medium.down,
                       fonts->medium.disabled);
        addSmallButton(getLocaleGuiString(
                           "gui_pm_new"),    COMMANDS_NEW, fonts->medium.normal, fonts->medium.highlighted,
                       fonts->medium.down,
                       fonts->medium.disabled);
        addSmallButton(getLocaleGuiString(
                           "gui_pm_delete"), COMMANDS_DELETE, fonts->medium.normal, fonts->medium.highlighted,
                       fonts->medium.down,
                       fonts->medium.disabled);
...
//.............................................................................
    ...
    void ProfilesMenu::applyChanges()
    {
        ...
        game::SimpleOptions::setInt( DH_OPT_I_1ST_PLAYER_CONTROL_SCHEME, game->gameUI->getController(
                                         0)->getControllerType() );
