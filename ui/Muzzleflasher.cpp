...
namespace ui
{
    ...
    void Muzzleflasher::deleteMuzzleflash(IPointableObject *unit, const std::string &name)
    {
        ...
        if (vo != NULL)
            ...
            Logger::getInstance()->warning(
                 ("Muzzleflasher::deleteMuzzleflash - no object found with name: " + name).c_str() );
    }
    ...
    bool Muzzleflasher::getMuzzleflash(IPointableObject  *unit,
                                       VisualObject      *muzzleflash,
    ...
    void Muzzleflasher::updateMuzzleflash(IPointableObject  *unit,
                                          VisualObject      *muzzleflash,
                                          const std::string &name,
                                          const std::string &helper,
                                          const VC3         &pos,
