...
namespace ui
{
    CommandWindow::CommandWindow(Ogui *ogui, game::Game *game, int player)
    {
        ...
        b = ogui->CreateSimpleTextButton(win,
                                         ...
                                         573,
                                         27,
                                         "Data/GUI/Buttons/mainmenu_button_normal.tga",
                                         "Data/GUI/Buttons/mainmenu_button_high.tga",
                                         "Data/GUI/Buttons/mainmenu_button_high.tga",
                                         getLocaleGuiString("gui_mm_new_game"),
                                         COMMANDW_COMBAT);
        b->SetListener(this);
        buttons->append(b);
        b->SetFont(font);
        ...
        for (i = 1; i <= 3; i++) {
            b = ogui->CreateSimpleTextButton(win,
                                             ...
                                             "Data/GUI/Buttons/mainmenu_button_high.tga",
                                             "Data/GUI/Buttons/mainmenu_button_high.tga",
                                             getLocaleGuiString("gui_mm_options"),
                                             COMMANDW_COMBAT);
            b->SetListener(this);
            buttons->append(b);
            b->SetFont(font);
        ...
        b = ogui->CreateSimpleTextButton(win,
                                         ...
                                         "Data/GUI/Buttons/mainmenu_button_high.tga",
                                         "Data/GUI/Buttons/mainmenu_button_high.tga",
                                         getLocaleGuiString("gui_mm_credits"),
                                         COMMANDW_COMBAT);
        b->SetListener(this);
        buttons->append(b);
        b->SetFont(font);
        ...
        b = ogui->CreateSimpleTextButton(win,
                                         ...
                                         "Data/GUI/Buttons/mainmenu_button_high.tga",
                                         "Data/GUI/Buttons/mainmenu_button_high.tga",
                                         getLocaleGuiString("gui_mm_quit"),
                                         COMMANDW_QUIT);
        b->SetListener(this);
        buttons->append(b);
        b->SetFont(font);
