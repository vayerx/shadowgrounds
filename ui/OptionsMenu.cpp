...
///////////////////////////////////////////////////////////////////////////////
        ...
        currentProfile("")
    {
        ...
        ogui = o_gui;
        win =
            ogui->CreateSimpleWindow(getLocaleGuiInt("gui_optionsmenu_window_x",
                                                     0), getLocaleGuiInt("gui_optionsmenu_window_y",
                                                                         0), getLocaleGuiInt("gui_optionsmenu_window_w",
                                                                                             1024),
                                     getLocaleGuiInt("gui_optionsmenu_window_h", 768), NULL);
        win->Hide();
        win->SetUnmovable();
        ...
        buttonAddX  =
            getLocaleGuiInt( "gui_optionsmenu_button_add_x", getLocaleGuiInt("gui_menu_common_button_add_x", 0) );
        buttonAddY  =
            getLocaleGuiInt( "gui_optionsmenu_button_add_y", getLocaleGuiInt("gui_menu_common_button_add_y", 28) );
            ...
            while ( sp.next() ) {
                ...
                if (tmp != NULL && tmp[0] != '\0') {
                    ...
                    if (ctrlNum != -1) {
                        ...
                        LOG_ERROR_W_DEBUG(
                            "OptionsMenu - Options menu keybinds configuration file contained an unknown control name.",
                            tmp);
                    }
                }
            }
        ...
        // Slider buttons
        {
            ...
            std::string sliderButtonBackgroundNormal =  getLocaleGuiString(
                "gui_optionsmenu_slider_button_background_normal");
            std::string sliderButtonBackgroundDown =    getLocaleGuiString(
                "gui_optionsmenu_slider_button_background_down");
            std::string sliderButtonBackgroundHigh =    getLocaleGuiString(
                "gui_optionsmenu_slider_button_background_high");

            std::string sliderButtonForegroundNormal =  getLocaleGuiString(
                "gui_optionsmenu_slider_button_foreground_normal");
            std::string sliderButtonForegroundDown =    getLocaleGuiString(
                "gui_optionsmenu_slider_button_foreground_down");
            std::string sliderButtonForegroundHigh =    getLocaleGuiString(
                "gui_optionsmenu_slider_button_foreground_high");
            ...
            slider = new OguiSlider(win,
                                    ogui,
                                    sliderButtonX,
                                    sliderButtonY,
                                    sliderButtonW,
                                    sliderButtonH,
                                    sliderButtonBackgroundNormal,
                                    sliderButtonBackgroundDown,
                                    sliderButtonBackgroundHigh,
                                    sliderButtonForegroundNormal,
                                    sliderButtonForegroundDown,
                                    sliderButtonForegroundHigh,
                                    COMMANDS_SLIDERMUSIC,
                                    sliderMusicValue);
            ...
            //
            ambientOptionAvailable = DHLocaleManager::getInstance()->hasString(DHLocaleManager::BANK_GUI,
                                                                               "gui_optionsmenu_text_ambient");
            if (ambientOptionAvailable) {
                ...
                slider = new OguiSlider(win,
                                        ...
                                        sliderButtonForegroundDown,
                                        sliderButtonForegroundHigh,
                                        COMMANDS_SLIDERAMBIENT,
                                        sliderAmbientValue);

                addText(textAmbient, sliderTextX, sliderTextY, sliderTextW, sliderTextH, fonts->medium.highlighted);

                slider->setBarPosition(sliderButtonX + sliderClipX,
                                       sliderButtonY + sliderClipY,
                                       sliderClipW,
                                       sliderClipH);
                slider->setListener(this);
                sliderButtons.push_back(slider);
...

        {
            ...
            for (i = 1; i <= options_max; i++) {
                ...
                addControlDescription(getOptionsKeyName(
                                          i), i, key_name_add_x, 0, fonts->little.normal, fonts->little.highlighted,
                                      fonts->little.down,
                                      fonts->little.disabled);
...
#endif
        /*OguiButton* b = */ addButton(getLocaleGuiString(
                                           "gui_om_defaults"), COMMANDS_DEFAULTS, fonts->medium.normal,
                                       fonts->medium.highlighted, fonts->medium.down,
                                       fonts->medium.disabled);
        ...
        if (getNumberOfPlayers() == 1) {
            ...
            cameraModeHack->setText( ( (std::string)getLocaleGuiString(
                                           "demo_camera_name") ).c_str(), OguiCheckBox::TEXT_ALIGN_RIGHT, 200,
                                     fonts->little.highlighted );
        ...
        // controller type
        {
            ...
            controllerTypeButton = ogui->CreateSimpleTextButton(win,
                                                                x,
                                                                y,
                                                                w,
                                                                h,
...

        {
            ...
            addText(getLocaleGuiString(
                        "gui_optionsmenu_gammatext"), text_x, text_y, text_w, text_h, fonts->medium.highlighted);
        }
...
//.............................................................................
    ...
    void OptionsMenu::applyChanges()
    {
        ...
        SimpleOptions::setInt( DH_OPT_I_1ST_PLAYER_CONTROL_SCHEME + cooperativeSelection,
    ...
    void OptionsMenu::CursorEvent(OguiButtonEvent *eve)
    {
        if (eve->triggerButton == controllerTypeListCaptureEvents) {
            ...
            if (controllerTypeList) {
                ...
                if (but != NULL)
                    if ( x >= but->GetX() && x <= but->GetX() + but->GetSizeX() && y >= but->GetY() && y <=
                         but->GetY() + but->GetSizeY() )
                        hit_scroller = true;
    ...
    void OptionsMenu::sliderEvent(OguiSliderEvent *eve)
    {
        ...
        if (sounds_updated) {
            ...
            if ( game->getGameUI()->getSoundMixer() )
                game->getGameUI()->getSoundMixer()->setVolume(100,
                                                              soundVolume,
                                                              speechVolume,
                                                              musicVolume,
                                                              ambientVolume);
        ...
        if (controlUpdate != -1) {
            ...
            if (keycode != -1) {
                ...
                if ( gameController->isKeyDownByKeyCode(KEYCODE_JOY_BUTTON1)
                     ...
                     || gameController->isKeyDownByKeyCode(KEYCODE_JOY_BUTTON9)
...
//.............................................................................
    ...
    void OptionsMenu::addDifficultButton(int                x,
                                         int                y,
                                         int                w,
                                         int                h,
                                         const std::string &button_norm,
                                         const std::string &button_down,
                                         const std::string &button_high,
                                         IOguiFont         *font,
...
//.............................................................................
    ...
    void OptionsMenu::addControlDescription(const std::string &text,
                                            int                id,
                                            int                x_add,
                                            int                y_add,
                                            IOguiFont         *font,
                                            ...
                                            IOguiFont         *disa)
    {
        ...
        OguiButton *foo;
        foo = ogui->CreateSimpleTextButton( win, x, y, buttonDescriptionW, buttonDescriptionH, NULL, NULL, NULL,
                                            text.c_str() );
...
///////////////////////////////////////////////////////////////////////////////
    ...
    void OptionsMenu::determineCurrentController()
    {
        ...
        if (currentController >= GameController::CONTROLLER_TYPE_JOYSTICK1 && currentController <=
            GameController::CONTROLLER_TYPE_JOYSTICK4)
            createJoystickButtons();
        else
            freeJoystickButtons();
...
//=============================================================================
    ...
    void OptionsMenu::setJoystickAxis(int axis, GameController::JOYSTICK_AXIS button)
    {
        ...
        controlDescriptions[ axis ]->SetText( getKeyNameFromLocales( gameController->getJoystickAxisName(
                                                                         button) ).c_str() );
    }
            ...
            return;
        {
...

            {
                ...
                std::string button_name =
                    getKeyNameFromLocales( gameController->getJoystickAxisName( gameController->getJoystickMoveXAxis() ) );

                addControlDescription(button_name,
            ...
            //.....................................................................
            {
                ...
                std::string button_name =
                    getKeyNameFromLocales( gameController->getJoystickAxisName( gameController->getJoystickMoveYAxis() ) );
            ...
            //.....................................................................
            {
                ...
                std::string button_name =
                    getKeyNameFromLocales( gameController->getJoystickAxisName( gameController->getJoystickDirXAxis() ) );
            ...
            //.....................................................................
            {
                ...
                std::string button_name =
                    getKeyNameFromLocales( gameController->getJoystickAxisName( gameController->getJoystickDirYAxis() ) );
...
///////////////////////////////////////////////////////////////////////////////
    ...
    void OptionsMenu::openCoopProfileMenu()
    {
        ...
        if (selectListStyle == NULL) {
            ...
            selectListStyle = new OguiSelectListStyle(unselStyle,
                                                      selStyle,
                                                      newStyle,
                                                      newUnStyle,
                                                      scrollUpStyle,
                                                      scrollDownStyle,
                                                      unselStyle->sizeX,
                                                      unselStyle->sizeY * num_of_elements,
                                                      scrollUpStyle->sizeX,
                                                      scrollUpStyle->sizeY);
...

        {
            ...
            for (i = 0; i < getNumberOfPlayers(); i++) {
                cooperativeProfileList->addItem( game->getGameProfiles()->getCurrentProfile(i),
                                                 game->getGameProfiles()->getCurrentProfile(i) );
                if (i == cooperativeSelection) {
...
///////////////////////////////////////////////////////////////////////////////
    ...
    void OptionsMenu::createMouseButtons()
    {
        // Lock y axis
        {
            ...
            cameraLockYAxis->setText( ( (std::string)getLocaleGuiString(
                                            "camera_lock_y_axis") ).c_str(), OguiCheckBox::TEXT_ALIGN_RIGHT, 200,
                                      fonts->little.highlighted );
...

        {
            ...
            cameraRotateStrength = new OguiSlider(win,
                                                  ogui,
                                                  x,
                                                  y,
                                                  w,
            ...
            cameraSpringStrength = new OguiSlider(win,
                                                  ogui,
                                                  x,
                                                  y,
                                                  w,
...
// Temp hack for FB to disable pad
        ...
        // mouse controller
        if (type >= GameController::CONTROLLER_TYPE_KEYBOARD_AND_MOUSE1 && type <=
        ...
        else if (type >= GameController::CONTROLLER_TYPE_JOYSTICK1 && type <=
                 GameController::CONTROLLER_TYPE_JOYSTICK4) {
    ...
    void OptionsMenu::setControllerType(int type)
    {
        ...
        for (unsigned int i = 0; i < controlNumArray.size(); i++) {
            ...
            int keycode_0 =
                gameController->convertKeyToController(gameController->getBoundKey(key,
                                                                                   0),
                                                       (GameController::CONTROLLER_TYPE)currentController);
    ...
    void OptionsMenu::openControllerTypeList()
    {
        ...
        controllerTypeListCaptureEvents =
            ogui->CreateSimpleImageButton(win,
                                          getLocaleGuiInt("gui_optionsmenu_window_x",
                                                          0), getLocaleGuiInt("gui_optionsmenu_window_y",
                                                                              0),
                                          getLocaleGuiInt("gui_optionsmenu_window_w",
                                                          1024),
                                          getLocaleGuiInt("gui_optionsmenu_window_h", 768), NULL, NULL, NULL, 0);
        ...
        if (controllerTypeListStyle == NULL) {
            ...
            controllerTypeListStyle = new OguiSelectListStyle(unselStyle,
                                                              selStyle,
                                                              newStyle,
                                                              newUnStyle,
                                                              scrollUpStyle,
        ...
        for (int i = 0; i < num_mouses; i++) {
            ...
            std::string value = boost::lexical_cast<std::string>(
                GameController::CONTROLLER_TYPE_KEYBOARD_AND_MOUSE1 + i);
