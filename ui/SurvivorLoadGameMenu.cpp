...
namespace ui
{
    SurvivorLoadGameMenu::SurvivorLoadGameMenu(MenuCollection *menu, MenuCollection::Fonts *fonts, Ogui *o_gui,
                                               Game *g) :
        MenuBaseImpl(NULL),
        menuCollection(menu),
        fonts(fonts),
        ...
        startedHoldingScroll(-1)
    {
        ...
        {
            headerTextX =
                getLocaleGuiInt( "gui_survivorloadgamemenu_header_x", getLocaleGuiInt("gui_menu_common_header_x", 0) );
            headerTextY =
                getLocaleGuiInt( "gui_survivorloadgamemenu_header_y", getLocaleGuiInt("gui_menu_common_header_y", 0) );
        ...
        //
        {
            ...
            buttonW = w;
            buttonH = h;
            OguiButton *but = addButton(getLocaleGuiString(
                                            "gui_lgm_load"), COMMANDS_LOAD, fonts->medium.normal,
        ...
        for (int savegame_id = 1;; savegame_id++) {
            std::string temp = std::string("gui_survivorloadgamemenu_mission_") + boost::lexical_cast< std::string >(
                savegame_id) + "_image_norm";
        ...
        // create mission buttons
        {
            ...
            for (int i = 0; i < 4; i++) {
                missionInfos[i].button = ogui->CreateSimpleImageButton(win,
                                                                       x,
                                                                       y,
                                                                       w,
                                                                       h,
                                                                       ...
                                                                       0,
                                                                       false);
                missionInfos[i].button->SetEventMask(
                    OguiButtonEvent::EVENT_TYPE_CLICK | OguiButtonEvent::EVENT_TYPE_OVER
                    | OguiButtonEvent::EVENT_TYPE_LEAVE);
                ...
                missionInfos[i].highlight_button = ogui->CreateSimpleImageButton(win,
                                                                                 x,
                                                                                 y,
                                                                                 w,
                                                                                 h,
                                                                                 ...
                                                                                 NULL,
                                                                                 getLocaleGuiString(
                                                                                     "gui_survivorloadgamemenu_mission_highlight"),
                                                                                 0,
                                                                                 0,
                                                                                 false);
        ...
        // scroll buttons
        {
            ...
            nextButton = ogui->CreateSimpleImageButton(win,
                                                       x,
                                                       y,
                                                       w,
                                                       h,
...

        {
            ...
            prevButton = ogui->CreateSimpleImageButton(win,
                                                       x,
                                                       y,
                                                       w,
                                                       h,
    ...
    void SurvivorLoadGameMenu::update()
    {
        ...
        // right most button scrolled out
            ...
            for (int i = 0; i < 4; i++) {
                missionInfos[i].button->Move(missionButtonStartPosX + missionButtonOffsetX * (i - 1),
                                             missionButtonStartPosY);
            }
    ...
    inline void addQuad(OguiButton::Vertex *vertices,
                        int                 x,
                        int                 y,
                        int                 size_x,
                        int                 size_y,
                        unsigned char       alpha_left,
                        unsigned char       alpha_right)
    {
    ...
    void SurvivorLoadGameMenu::clipMissionButtons()
    {
        for (int i = 0; i < 4; i++) {
            ...
            int deltaRight = missionInfos[i].button->GetX() + missionInfos[i].button->GetSizeX()
                             - missionButtonClipRight;
            if (deltaRight > 0) {
    ...
    bool SurvivorLoadGameMenu::loadMissionInfo(MissionInfo *mi, int savegame_id)
    {
        ...
        if ( !game->getInfoForSavegame(savegame.str().c_str(), "savegame") ) {
            ...
            //if(savegame_id > 0)
            {
                button->SetDisabledImage( ogui->LoadOguiImage( getLocaleGuiString(
                                                                   "gui_survivorloadgamemenu_missionimage_empty") ) );
