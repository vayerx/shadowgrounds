...
namespace ui
{
    void DebugProjectileVisualizer::visualizeProjectiles(game::ProjectileList *projectiles, const VC3 &cameraPosition)
    {
        ...
        while ( iter.iterateAvailable() ) {
            ...
            VC3 cb4_extra = VC3(pos.x - sizes.x + extra_offset_x,
                                pos.y + extra_offset_y,
                                pos.z + extra_offset_z - extra_size);
            VC3 cb4_extra2 = VC3(pos.x - sizes.x + extra_offset_x,
                                 pos.y + extra_offset_y,
                                 pos.z + extra_offset_z + extra_size);
            VC3 cb4_extra3 = VC3(pos.x - sizes.x + extra_offset_x,
                                 pos.y + extra_offset_y - extra_size,
                                 pos.z + extra_offset_z);
            VC3 cb4_extra4 = VC3(pos.x - sizes.x + extra_offset_x,
                                 pos.y + extra_offset_y + extra_size,
                                 pos.z + extra_offset_z);
            VC3 cb4_extra5 = VC3(pos.x - sizes.x + extra_offset_x - extra_size,
                                 pos.y + extra_offset_y,
                                 pos.z + extra_offset_z);
            VC3 cb4_extra6 = VC3(pos.x - sizes.x + extra_offset_x + extra_size,
                                 pos.y + extra_offset_y,
                                 pos.z + extra_offset_z);
            ...
            if ( game::SimpleOptions::getBool(DH_OPT_B_DEBUG_VISUALIZE_PROJECTILES_EXTENDED)
                 && distToCamSq <
                 (DEBUGPROJECTILEVISUALIZER_EXTENDED_MAX_DIST * DEBUGPROJECTILEVISUALIZER_EXTENDED_MAX_DIST) )
            {
