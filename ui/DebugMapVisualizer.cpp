...
namespace ui
{
    void DebugMapVisualizer::visualizeObstacleMap(game::GameMap   *gameMap,
        ...
        for (int oy = 0; oy < gameMap->getObstacleSizeY(); oy++) {
            for (int ox = 0; ox < gameMap->getObstacleSizeX(); ox++) {
                    ...
                    && fabsf(sy - cameraPosition.z) < DEBUGMAPVISUALIZER_MAX_DIST)
                {
                    ...
                    VC3 blocksize =
                        VC3(
                             gameMap->getScaleX() * (0.5f / GAMEMAP_HEIGHTMAP_MULTIPLIER / GAMEMAP_PATHFIND_ACCURACY),
                            obst_sheight, gameMap->getScaleY()
                            * (0.5f / GAMEMAP_HEIGHTMAP_MULTIPLIER / GAMEMAP_PATHFIND_ACCURACY) );
                    ...
                    //if (distToCamSq < (DEBUGMAPVISUALIZER_MAX_DIST*DEBUGMAPVISUALIZER_MAX_DIST)
                    {
                        ...
                        if (oheight > 0) {
                            ...
                            case SLOPE_TYPE_LEFT_22_5_LOWER:
                                ...
                                disposable_scene->AddLine( (c1 + c4) * 0.5f, (c1 + c4) * 0.5f + VC3(0,
                                                                                                    -2,
                                                                                                    0), colBlocked );
                                break;
                            ...
                            case SLOPE_TYPE_RIGHT_22_5_LOWER:
                                ...
                                disposable_scene->AddLine( (c2 + c3) * 0.5f, (c2 + c3) * 0.5f + VC3(0,
                                                                                                    -2,
                                                                                                    0), colBlocked );
                                break;
