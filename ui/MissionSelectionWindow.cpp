...
///////////////////////////////////////////////////////////////////////////////
    class MissionSelectionWindow::MissionSelectionWindowImpl : private IOguiButtonListener,
    ...
    public:
        ...
        void ExecuteSelectedMission()
        {
            ...
            if ( i != missionButtons.end() )
                ...
                game->gameScripting->runMissionScript(
                     i->second->missionScriptName.c_str(), i->second->missionSubName.c_str() );
        }
