...
namespace ui {
    ...
    TacticalUnitWindow::TacticalUnitWindow(Ogui *ogui, game::Game *game)
    {
        ...
        // Buttons
        OguiButton *b;
        b = data->ogui.CreateSimpleImageButton(data->window,
                                               8,
                                               5 + 17 * 3,
                                               24,
                                               16,
                                               "Data/GUI/Ingame/Menuicons/action_stealth.tga",
                                               0,
                                               0,
                                               STEALTH_MOVE_BUTTON);
        ...
        b = data->ogui.CreateSimpleImageButton(data->window,
                                               ...
                                               24,
                                               16,
                                               "Data/GUI/Ingame/Menuicons/action_normal.tga",
                                               0,
                                               0,
                                               NORMAL_MOVE_BUTTON);
        b->SetReactMask(0);
        ...
        b = data->ogui.CreateSimpleImageButton(data->window,
                                               ...
                                               24,
                                               16,
                                               "Data/GUI/Ingame/Menuicons/action_fast.tga",
                                               0,
                                               0,
                                               FAST_MOVE_BUTTON);
        b->SetReactMask(0);
        ...
        b = data->ogui.CreateSimpleImageButton(data->window,
                                               ...
                                               24,
                                               16,
                                               "Data/GUI/Ingame/Menuicons/action_firebasic.tga",
                                               0,
                                               0,
                                               PRIMARY_FIRE_BUTTON);
        b->SetReactMask(0);
        ...
        b = data->ogui.CreateSimpleImageButton(data->window,
                                               ...
                                               24,
                                               16,
                                               "Data/GUI/Ingame/Menuicons/action_fireheavy.tga",
                                               0,
                                               0,
        ...
        b = data->ogui.CreateSimpleImageButton(data->window,
                                               ...
                                               24,
                                               16,
                                               "Data/GUI/Ingame/Menuicons/action_fireall.tga",
                                               0,
                                               0,
                                               BOTH_FIRE_BUTTON);
        b->SetReactMask(0);
        ...
        b = data->ogui.CreateSimpleImageButton(data->window,
                                               ...
                                               24,
                                               16,
                                               "Data/GUI/Ingame/Menuicons/action_stop.tga",
                                               0,
                                               0,
                                               STOPMOVE_BUTTON);
        b->SetReactMask(0);
        ...
        b = data->ogui.CreateSimpleImageButton(data->window,
                                               ...
                                               24,
                                               15,
                                               "Data/GUI/Ingame/Menuicons/action_ceasefire.tga",
                                               0,
                                               0,
                                               STOPFIRE_BUTTON);
        b->SetReactMask(0);
        ...
        // Texts
        b = data->ogui.CreateSimpleTextButton(data->window,
                                              8,
                                              6 + 17 * 3,
                                              96,
                                              16,
                                              ...
                                              0,
                                              "    Sneak",
                                              STEALTH_MOVE_BUTTON);    b->SetListener(this); b->SetFont(
            defaultSmallIngameFont); b->SetTextHAlign(
        ...
        b = data->ogui.CreateSimpleTextButton(data->window,
                                              ...
                                              0,
                                              "    Move",
                                              NORMAL_MOVE_BUTTON);      b->SetListener(this); b->SetFont(
            defaultSmallIngameFont); b->SetTextHAlign(
            OguiButton::TEXT_H_ALIGN_LEFT);
        b->SetHighlightedImage(data->highlightImage);
        b = data->ogui.CreateSimpleTextButton(data->window,
                                              ...
                                              0,
                                              "    Move fast",
                                              FAST_MOVE_BUTTON);   b->SetListener(this); b->SetFont(
            defaultSmallIngameFont); b->SetTextHAlign(
            OguiButton::TEXT_H_ALIGN_LEFT);
        b->SetHighlightedImage(data->highlightImage);
        b = data->ogui.CreateSimpleTextButton(data->window,
                                              ...
                                              0,
                                              "    Fire basic",
                                              PRIMARY_FIRE_BUTTON);   b->SetListener(this); b->SetFont(
            defaultSmallIngameFont); b->SetTextHAlign(
            OguiButton::TEXT_H_ALIGN_LEFT);
        b->SetHighlightedImage(data->highlightImage);
        ...
        b = data->ogui.CreateSimpleTextButton(data->window,
                                              ...
                                              0,
                                              "    Fire heavy",
                                              SECONDARY_FIRE_BUTTON); b->SetListener(this); b->SetFont(
            defaultSmallIngameFont); b->SetTextHAlign(
            OguiButton::TEXT_H_ALIGN_LEFT);
        b->SetHighlightedImage(data->highlightImage);
        ...
        b = data->ogui.CreateSimpleTextButton(data->window,
                                              ...
                                              0,
                                              "    Fire all",
                                              BOTH_FIRE_BUTTON);    b->SetListener(this); b->SetFont(
            defaultSmallIngameFont); b->SetTextHAlign(
            OguiButton::TEXT_H_ALIGN_LEFT);
        b->SetHighlightedImage(data->highlightImage);
        data->fireAllBut = b;
        b = data->ogui.CreateSimpleTextButton(data->window, 8, 6 + 17 * 0, 96, 16, 0, 0, 0, "    Stop", STOPMOVE_BUTTON);
        b->SetListener(this); b->SetFont(defaultSmallIngameFont); b->SetTextHAlign(OguiButton::TEXT_H_ALIGN_LEFT);
        b->SetHighlightedImage(data->highlightImage);
        b = data->ogui.CreateSimpleTextButton(data->window,
                                              8,
                                              5 + 6 + 17 * 4,
                                              ...
                                              0,
                                              "    Cease fire",
                                              STOPFIRE_BUTTON);    b->SetListener(this); b->SetFont(
            defaultSmallIngameFont); b->SetTextHAlign(
            OguiButton::TEXT_H_ALIGN_LEFT);
        b->SetHighlightedImage(data->highlightImage);
    ...
    void TacticalUnitWindow::showAt(int                        xPosition,
                                    int                        yPosition,
                                    std::vector<game::Unit *> *unitsSelected,
                                    game::Unit                *targetUnit)
    {
