...
///////////////////////////////////////////////////////////////////////////////
        ...
        public:
            ...
            {
                addComboItems( GetDlgItem(hwnd, IDC_COMBOLANGUAGE), manager.getOptionNames(
                                   "Language"), manager.getTheOneInUse("Language") );
                addComboItems( GetDlgItem(hwnd, IDC_COMBORESOLUTION), manager.getOptionNames(
                                   "Resolution"), manager.getTheOneInUse("Resolution") );
                addComboItems( GetDlgItem(hwnd, IDC_COMBOGFXDETAIL), manager.getOptionNames(
                                   "GraphicsDetail"), manager.getTheOneInUse("GraphicsDetail") );
                addComboItems( GetDlgItem(hwnd, IDC_COMBOSPEAKERTYPE), manager.getOptionNames(
                                   "SpeakerType"), manager.getTheOneInUse("SpeakerType") );
                addComboItems( GetDlgItem(hwnd, IDC_COMBOMIXINGRATE), manager.getOptionNames(
                                   "MixingRate"), manager.getTheOneInUse("MixingRate") );
                addComboItems( GetDlgItem(hwnd, IDC_COMBOPHYSICSDETAIL),  manager.getOptionNames(
                ...
                setCheckBox( hwnd, IDC_PHYSICSHW, manager.getTheOneInUse("Physics Hardware") );
...
#ifdef FB_RU_HAX
                    std::wstring nomod = ::game::DHLocaleManager::getInstance()->getWideString(
                        ::game::DHLocaleManager::BANK_GUI,
                        "launcher_no_mod");
                    SendMessageW( GetDlgItem(hwnd,
                                             IDC_COMBOMODSELECTION), CB_ADDSTRING, (WPARAM)0, (LPARAM) nomod.c_str() );
                ...
                setDescriptionText( GetDlgItem(hwnd, IDC_PHYSICSHW) );
            ...
            void applyOptions(HWND hwnd)
            {
                ...
                manager.applyOptions( "Physics Hardware",               getCheckBoxValue(hwnd, IDC_PHYSICSHW) );
            }
                ...
                case WM_COMMAND: {
                    ...
                    case IDOK:
                        ...
                        if (modIndex >= 0) {
                            ...
                            ShellExecute(0, 0, "Shadowgrounds.exe", parameters.c_str(), 0, SW_NORMAL);
                        } else {
                            ShellExecute(0, 0, "Shadowgrounds.exe", 0, 0, SW_NORMAL);
                        }
