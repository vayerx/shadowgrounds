...
///////////////////////////////////////////////////////////////////////////////
        ...
        public:
            ...
            {
                addComboItems( GetDlgItem(hwnd,
                                          IDC_COMBOFAKESHADOWSTEXTUREQUALITY),  manager.getOptionNames(
                                   "Fake Shadows Texture Quality"),
                               manager.getTheOneInUse("Fake Shadows Texture Quality") );
                addComboItems( GetDlgItem(hwnd,
                                          IDC_COMBOLIGHTINGLEVEL),              manager.getOptionNames(
                                   "Lighting Level"),                 manager.getTheOneInUse("Lighting Level") );
                addComboItems( GetDlgItem(hwnd,
                                          IDC_COMBOLIGHTNINGTEXTUREQUALITY),    manager.getOptionNames(
                                   "Lighting Texture Quality"),       manager.getTheOneInUse("Lighting Texture Quality") );
                addComboItems( GetDlgItem(hwnd,
                                          IDC_COMBOPARTICLEEFFECTSLEVEL),       manager.getOptionNames(
                                   "Particle Effects Level"),         manager.getTheOneInUse("Particle Effects Level") );
                addComboItems( GetDlgItem(hwnd,
                                          IDC_COMBOSHADOWSLEVEL),               manager.getOptionNames(
                                   "Shadows Level"),                  manager.getTheOneInUse("Shadows Level") );
                addComboItems( GetDlgItem(hwnd,
                                          IDC_COMBOSHADOWSTEXTUREQUALITY),      manager.getOptionNames(
                                   "Shadows Texture Quality"),        manager.getTheOneInUse("Shadows Texture Quality") );
                addComboItems( GetDlgItem(hwnd,
                                          IDC_COMBOTEXTUREDETAILLEVEL),         manager.getOptionNames(
                                   "Texture Detail Level"),           manager.getTheOneInUse("Texture Detail Level") );
                addComboItems( GetDlgItem(hwnd,
                                          IDC_COMBOANISOTROPIC),                manager.getOptionNames(
                                   "Anisotropic Filtering"),          manager.getTheOneInUse("Anisotropic Filtering") );
                addComboItems( GetDlgItem(hwnd,
                                          IDC_COMBOANTIALIAS),                  manager.getOptionNames(
                                   "Antialiasing"),                   manager.getTheOneInUse("Antialiasing") );
                addComboItems( GetDlgItem(hwnd, IDC_COMBOMISC),                       manager.getOptionNames(
                                   "Misc"),                           manager.getTheOneInUse("Misc") );
            ...
            {
                manager.applyOptions( "Fake Shadows Texture Quality",
                                      getComboBoxSelection( GetDlgItem(hwnd, IDC_COMBOFAKESHADOWSTEXTUREQUALITY) ) );
                manager.applyOptions( "Lighting Level",
                                      getComboBoxSelection( GetDlgItem(hwnd, IDC_COMBOLIGHTINGLEVEL) ) );
                manager.applyOptions( "Lighting Texture Quality",
                                      getComboBoxSelection( GetDlgItem(hwnd, IDC_COMBOLIGHTNINGTEXTUREQUALITY) ) );
                manager.applyOptions( "Particle Effects Level",
                                      getComboBoxSelection( GetDlgItem(hwnd, IDC_COMBOPARTICLEEFFECTSLEVEL) ) );
                manager.applyOptions( "Shadows Level",
                                      getComboBoxSelection( GetDlgItem(hwnd, IDC_COMBOSHADOWSLEVEL) ) );
                manager.applyOptions( "Shadows Texture Quality",
                                      getComboBoxSelection( GetDlgItem(hwnd, IDC_COMBOSHADOWSTEXTUREQUALITY) ) );
                manager.applyOptions( "Texture Detail Level",
                                      getComboBoxSelection( GetDlgItem(hwnd, IDC_COMBOTEXTUREDETAILLEVEL) ) );
                manager.applyOptions( "Anisotropic Filtering",
                                      getComboBoxSelection( GetDlgItem(hwnd, IDC_COMBOANISOTROPIC) ) );
                manager.applyOptions( "Antialiasing",
                                      getComboBoxSelection( GetDlgItem(hwnd, IDC_COMBOANTIALIAS) ) );
                manager.applyOptions( "Misc",
                                      getComboBoxSelection( GetDlgItem(hwnd, IDC_COMBOMISC) ) );
