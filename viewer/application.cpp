        ...
        namespace {
            struct SharedData {
                ...
                SharedData(editor::Storm          &storm_,
                           Model                  &model_,
                           editor::Dialog         &dialog_,
                           editor::Dialog         &renderDialog_,
                           editor::Camera         &camera_,
                           editor::ColorComponent &colorComponent_)
                    :   storm(storm_),
                    model(model_),
                ...
                void reload()
                {
                    ...
                    SendDlgItemMessage( dialog.getWindowHandle(), IDC_IDLES, CB_ADDSTRING, 0,
                                        reinterpret_cast<LPARAM>("(none)") );
                    SendDlgItemMessage( dialog.getWindowHandle(), IDC_EXPRESSIONS, CB_ADDSTRING, 0,
                                        reinterpret_cast<LPARAM>("(none)") );
                    ...
                    for (i = 0; i < prop.getExpressionAnimationAmount(); ++i) {
                        ...
                        SendDlgItemMessage(
                             dialog.getWindowHandle(), IDC_EXPRESSIONS, CB_ADDSTRING, 0,
                            reinterpret_cast<LPARAM>( name.c_str() ) );
                    }
                ...
                void updateDialog()
                {
                    ...
                    for (int i = 0; i < model.getAnimationCount(animationState); ++i) {
                        ...
                        SendDlgItemMessage(
                             dialog.getWindowHandle(), IDC_ANIMATIONS, LB_ADDSTRING, 0,
                            reinterpret_cast<LPARAM>( name.c_str() ) );
                    }
            ...
            while (!data->mustQuit) {
                ...
                if (data->storm.terrain) {
                    ...
                    data->storm.terrain->getRenderer().enableFeature( IStorm3D_TerrainRenderer::Glow,
                                                                      isCheckEnabled(data->mainDialog, IDC_GLOW) );
                    data->storm.terrain->getRenderer().enableFeature( IStorm3D_TerrainRenderer::BetterGlowSampling,
                                                                      isCheckEnabled(data->mainDialog,
                                                                                     IDC_IMPROVED_GLOW) );
                    ...
                    if ( isCheckEnabled(data->mainDialog, IDC_POP_MODE) ) {
                        ...
                        data->storm.terrain->getRenderer().setFloatValue(
                            IStorm3D_TerrainRenderer::GlowTransparencyFactor,
                            0.5f);
                        data->storm.terrain->getRenderer().setFloatValue(IStorm3D_TerrainRenderer::GlowAdditiveFactor,
                                                                         0.0f);
                    } else {
                    ...
                    data->storm.terrain->getRenderer().enableFeature( IStorm3D_TerrainRenderer::HalfRendering,
                                                                      isCheckEnabled(data->mainDialog,
                                                                                     IDC_HALF_RENDERING) );
                }
/*
 ...
 */
                ...
                BOOL success = FALSE;
                int anim_stop_time = GetDlgItemInt(
                    data->sharedData.dialog.getWindowHandle(), IDC_ANIMTIMER, &success, FALSE);
                if (success &&
