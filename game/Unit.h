...
namespace game
{
    ...
    public:
        ...
        inline void setVelocity(const VC3 &velocity) {
            assert(velocity.y >= -2.0f && velocity.y <= 2.0f);
        ...
        inline int getWeaponFireTime(unsigned int weapon) const {
            assert(weapon < UNIT_MAX_WEAPONS);
    ...
    public:
        ...
        void setTargetLockTimes(int release, int cancel) {
            targetLockReleaseTime = release; targetLockCancelTime =
                cancel;
        }
