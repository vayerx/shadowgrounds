...
namespace game
{
    CylinderPhysicsObject::CylinderPhysicsObject(GamePhysics *gamePhysics,
                                                 float        height,
                                                 float        radius,
                                                 float        mass,
                                                 int          collisionGroup,
    ...
    {
#ifdef PHYSICS_PHYSX
        boost::shared_ptr<frozenbyte::physics::ActorBase> actor = gamePhysics->getPhysicsLib()->createCylinderActor(
            height,
            radius,
            position);
