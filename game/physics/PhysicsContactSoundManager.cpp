        ...
        for (int i = 0; i < 2; i++) {
            ...
            if (o) {
                ...
                if (contact.contactForceLen >= smlist[smindex].requiredForce) {
                    ...
                    if (accel.GetSquareLength() >= smlist[smindex].requiredAcceleration
                        * smlist[smindex].requiredAcceleration
                        || angaccel.GetSquareLength() >= smlist[smindex].requiredAngularAcceleration
                ...
                if ( o != NULL && makeSound && ( impl->gameUI->game->gameTimer - o->getLastEffectSoundTick() ) >
                     (200 / GAME_TICK_MSEC) )
            ...
            if (makeSound) {
                ...
                if (soundlist.size() > 0) {
                    ...
                    impl->gameUI->playSoundEffect(
                        soundfile.c_str(), soundpos.x, soundpos.y, soundpos.z,
                        false, (int)(DEFAULT_SOUND_EFFECT_VOLUME * volumeFactor),
