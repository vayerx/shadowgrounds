        ...
        if ( sp.loadFile("data/part/partlist.txt") )
            ...
            while ( sp.next() ) {
                ...
                if (filename != NULL && filename[0] != '\0') {
                    ...
                    boost::shared_ptr<filesystem::IFileList> baseFiles =
                        filesystem::FilePackageManager::getInstance().findFiles(filename, "*_base.dhp");
                    boost::shared_ptr<filesystem::IFileList> files =
                        filesystem::FilePackageManager::getInstance().findFiles(filename, "*.dhp");
