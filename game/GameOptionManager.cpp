...
#  endif
    ...
    void GameOptionManager::load()
    {
...
#ifdef LEGACY_FILES
        filesystem::InputStream options_file = filesystem::FilePackageManager::getInstance().getFile(
        ...
        filesystem::InputStream locked_options_file = filesystem::FilePackageManager::getInstance().getFile(
            "Data/Misc/locked_game_options.txt");
