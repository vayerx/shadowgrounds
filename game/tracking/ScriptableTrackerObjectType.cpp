    ...
    namespace tracking
    {
        ...
        void ScriptableTrackerObjectType::doSelfInit()
        {
            if ( !this->script.empty() ) {
                ...
                trackerTypeForCurrentlyRunningScript = this;
                ret =
                    gameScripting->runOtherScript( this->script.c_str(), "get_area_of_interest_radius", NULL,
                                                   VC3(0, 0, 0) );
                ...
                trackerTypeForCurrentlyRunningScript = this;
                ret =
                    gameScripting->runOtherScript( this->script.c_str(), "get_allow_tick_balancing", NULL, VC3(0, 0, 0) );
                ...
                LOG_WARNING(
                    "ScriptableTrackerObjectType::doSelfInit - Cannot initialize self, as given script name is empty.");
            }
        }
        ...
        void ScriptableTrackerObjectType::setScriptableTrackerVariables(
