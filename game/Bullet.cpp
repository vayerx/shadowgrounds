        ...
        if (atSub == PARTTYPE_SUB_NONE) {
            if (strcmp(key, "lifetime") == 0) {
                ...
                Logger::getInstance()->warning(
                    "Bullet::setData - Use of \"lifetime\" key deprecated (use lifetimemsec or lifetimeticks instead).");
#endif
...
#ifndef PROJECT_SHADOWGROUNDS
                Logger::getInstance()->warning(
                    "Bullet::setData - Use of \"afterlifetime\" key deprecated (use afterlifetimemsec or afterlifetimeticks instead).");
#endif
...
#ifndef PROJECT_SHADOWGROUNDS
                Logger::getInstance()->warning(
                    "Bullet::setData - Use of \"proximitydroplifetime\" key deprecated (use proximitydroplifetimeticks instead).");
#endif
