        ...
        case GS_CMD_SUBSTRINGFROMSTART:
            if (gsd->stringValue != NULL) {
                if (intData < (int)strlen(gsd->stringValue)
                    ...
                    sp->debug(
                        "StringScripting::process - substringFromStart parameter value greater or equal to string length.");
            } else {
        ...
        case GS_CMD_SUBSTRINGFROMEND:
            if (gsd->stringValue != NULL) {
                ...
                if (intData < slen
                    ...
                    sp->debug(
                        "StringScripting::process - substringFromEnd parameter value greater or equal to string length.");
            } else {
