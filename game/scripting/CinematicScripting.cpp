                                     ...
                                     bool                *pause)
    {
        ...
        case GS_CMD_FADEOUT:
            if (intData >= GAME_TICK_MSEC) {
                ...
                sp->error(
                    "CinematicScripting::process - fadeOut parameter invalid, fade-out duration in msec expected.");
            }
            break;
        ...
        case GS_CMD_STARTMASKPICTUREFADEIN:
            if (intData > 0)
                ...
                sp->error(
                    "GameScripting::process - startMaskPictureFadeIn parameter out of range, fade-in duration expected.");
            break;
        ...
        case GS_CMD_STARTMASKPICTUREFADEOUT:
            if (intData > 0)
                ...
                sp->error(
                    "GameScripting::process - startMaskPictureFadeOut parameter out of range, fade-out duration expected.");
            break;
        ...
        case GS_CMD_STARTMASKPICTUREMOVEIN:
            if (intData > 0)
                ...
                sp->error(
                    "GameScripting::process - startMaskPictureMoveIn parameter out of range, move-in duration (msec) expected.");
            break;
        ...
        case GS_CMD_STARTMASKPICTUREMOVEOUT:
            if (intData > 0)
                ...
                sp->error(
                    "GameScripting::process - startMaskPictureMoveOut parameter out of range, move-out duration (msec) expected.");
            break;
        ...
        case GS_CMD_SETMASKPICTURETEXTTOSTRING:
            if (gsd->stringValue != NULL)
                ...
                sp->warning(
                    "CinematicScripting::process - Attempt to setMaskPictureTextToString for null string value.");
            break;
        ...
        case GS_CMD_ENDCONVERSATION:
            if (game->gameUI->getLipsyncManager() != NULL) {
                ...
                sp->warning(
                    "CinematicScripting::process - Attempt to call endConversation when no lipsync manager available (not in combat).");
            }
            break;
        ...
        case GS_CMD_STARTCONVERSATION:
            if (game->gameUI->getLipsyncManager() != NULL)
                ...
                sp->warning(
                    "CinematicScripting::process - Attempt to call startConversation when no lipsync manager available (not in combat).");
            break;
        ...
        case GS_CMD_SETCONVERSATIONUNITLEFT:
            if (game->gameUI->getLipsyncManager() != NULL) {
                if (gsd->unit != NULL) {
                    if (gsd->unit->getCharacter() != NULL) {
                        if (gsd->unit->getCharacter()->getLipsyncId() != NULL) {
                            ...
                            sp->warning(
                                "CinematicScripting::process - Attempt to call setConversationUnitLeft for character with no lipsync id.");
                        }
                    } else {
                        sp->warning(
                            "CinematicScripting::process - Attempt to call setConversationUnitLeft for unit with no character.");
                    }
                } else {
                ...
                sp->warning(
                    "CinematicScripting::process - Attempt to call setConversationUnitLeft when no lipsync manager available (not in combat).");
            }
            break;
        ...
        case GS_CMD_SETCONVERSATIONUNITRIGHT:
            if (game->gameUI->getLipsyncManager() != NULL) {
                if (gsd->unit != NULL) {
                    if (gsd->unit->getCharacter() != NULL) {
                        if (gsd->unit->getCharacter()->getLipsyncId() != NULL) {
                            ...
                            sp->warning(
                                "CinematicScripting::process - Attempt to call setConversationUnitRight for character with no lipsync id.");
                        }
                    } else {
                        sp->warning(
                            "CinematicScripting::process - Attempt to call setConversationUnitRight for unit with no character.");
                    }
                } else {
                ...
                sp->warning(
                    "CinematicScripting::process - Attempt to call setConversationUnitRight when no lipsync manager available (not in combat).");
            }
            break;
                    ...
                    if (gsd->unit->getCharacter() != NULL) {
                        if (stringData != NULL) {
                            if (gsd->unit->getCharacter()->getLipsyncId() != NULL) {
                                ...
                                sp->warning(
                                    "CinematicScripting::process - Attempt to setConversationIdleAnimationForUnit for character with no lipsync id.");
                            }
                        } else {
                            sp->warning(
                                "CinematicScripting::process - setConversationIdleAnimationForUnit parameter missing.");
                        }
                    } else {
                        sp->warning(
                            "CinematicScripting::process - Attempt to call setConversationIdleAnimationForUnit for unit with no character.");
                    }
                } else {
                    sp->warning(
                        "CinematicScripting::process - Attempt to call setConversationIdleAnimationForUnit for null unit.");
                }
            } else {
                sp->warning(
                    "CinematicScripting::process - Attempt to call setConversationIdleAnimationForUnit when no lipsync manager available (not in combat).");
            }
            break;
                    ...
                    if (gsd->unit->getCharacter() != NULL) {
                        if (stringData != NULL) {
                            if (gsd->unit->getCharacter()->getLipsyncId() != NULL) {
                                ...
                                sp->warning(
                                    "CinematicScripting::process - Attempt to setConversationExpressionAnimationForUnit for character with no lipsync id.");
                            }
                        } else {
                            sp->warning(
                                "CinematicScripting::process - setConversationExpressionAnimationForUnit parameter missing.");
                        }
                    } else {
                        sp->warning(
                            "CinematicScripting::process - Attempt to call setConversationExpressionAnimationForUnit for unit with no character.");
                    }
                } else {
                    sp->warning(
                        "CinematicScripting::process - Attempt to call setConversationExpressionAnimationForUnit for null unit.");
                }
            } else {
                sp->warning(
                    "CinematicScripting::process - Attempt to call setConversationExpressionAnimationForUnit when no lipsync manager available (not in combat).");
            }
            break;
                    ...
                    if (gsd->unit->getCharacter() != NULL) {
                        if (gsd->unit->getCharacter()->getLipsyncId() != NULL) {
                            ...
                            if (game->gameUI->getLipsyncManager()->getCharacter(util::LipsyncManager::Left) == str)
                                side = 0;
                            else if (game->gameUI->getLipsyncManager()->getCharacter(util::LipsyncManager::Right) ==
                                     str)
                                side = 1;
                            ...
                            if (side >= 0)
                                ...
                                sp->warning(
                                    "CinematicScripting::process - Attempt to setConversationNoiseForUnit for unit which is not active.");
                        } else {
                            sp->warning(
                                "CinematicScripting::process - Attempt to setConversationNoiseForUnit for character with no lipsync id.");
                        }
                    } else {
                        sp->warning(
                            "CinematicScripting::process - Attempt to call setConversationNoiseForUnit for unit with no character.");
                    }
                } else {
                    sp->warning(
                        "CinematicScripting::process - Attempt to call setConversationNoiseForUnit for null unit.");
                }
            } else {
                sp->warning(
                    "CinematicScripting::process - Attempt to call setConversationNoiseForUnit when no lipsync manager available (not in combat).");
            }
            break;
        ...
        case GS_CMD_setCustomFilterEffect:
            if (stringData != NULL) {
                const char *parse_error =
                    "CinematicScripting::process - setCustomFilterEffect expects format \"brightness,contrast,red,green,blue\" or \"disabled\"";
                if (strcmp(stringData, "disabled") == 0) {
