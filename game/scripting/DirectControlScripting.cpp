...
namespace game
{
		...
		GameScriptData *gsd, Game *game, bool *pause)
	{
...
#endif
							ScriptableAIDirectControl *sdc = (ScriptableAIDirectControl *)unit->getAIDirectControl();
							sdc->setTimerEventParameters(intData / GAME_TICK_MSEC);
#ifndef UNSAFE_DIRECT_CONTROL_SCRIPTING
						} else {
		...
		case GS_CMD_directControlAddCustomEventUsingTimeMsecValue:
			if (stringData != NULL)
			{
...
#endif
								ScriptableAIDirectControl *sdc = (ScriptableAIDirectControl *)unit->getAIDirectControl();
								sdc->addCustomEvent(*lastValue / GAME_TICK_MSEC, stringData);
#ifndef UNSAFE_DIRECT_CONTROL_SCRIPTING
							} else {
								sp->error("DirectControlScripting::process - directControlAddCustomEventUsingTimeMsecValue, unit's \"directcontroltype\" is not \"scriptable\".");
							}
						} else {
							sp->error("DirectControlScripting::process - directControlAddCustomEventUsingTimeMsecValue, unit is not \"directcontrol\" type or not controlled by AI.");
						}
#endif
					} else {
						sp->error("DirectControlScripting::process - Attempt to directControlAddCustomEventUsingTimeMsecValue for null unit.");
					}
				} else {
					sp->error("DirectControlScripting::process - directControlAddCustomEventUsingTimeMsecValue value bad (value less than one tick in msec).");
				}
			} else {
				sp->error("DirectControlScripting::process - directControlAddCustomEventUsingTimeMsecValue parameter missing.");
			}
			break;

		case GS_CMD_directControlClearEventFlagByName:
			if (stringData != NULL)
			{
				if (unit != NULL)
				{
...
#endif
								ScriptableAIDirectControl *sdc = (ScriptableAIDirectControl *)unit->getAIDirectControl();
								sdc->clearEventFlag(eventMask);
#ifndef UNSAFE_DIRECT_CONTROL_SCRIPTING
							} else {
								sp->error("DirectControlScripting::process - directControlClearEventFlagByName, unit's \"directcontroltype\" is not \"scriptable\".");
							}
						} else {
							sp->error("DirectControlScripting::process - directControlClearEventFlagByName, unit is not \"directcontrol\" type or not controlled by AI.");
						}
					} else {
						sp->error("DirectControlScripting::process - directControlClearEventFlagByName parameter invalid (expected direct control event name).");
					}
#endif
				} else {
					sp->error("DirectControlScripting::process - Attempt to directControlClearEventFlagByName for null unit.");
				}
			} else {
				sp->error("DirectControlScripting::process - Attempt to directControlClearEventFlagByName parameter missing.");
			}
			break;

		case GS_CMD_directControlClearObjectTouchLeftEventFlag:
			if (unit != NULL)
			{
#ifndef UNSAFE_DIRECT_CONTROL_SCRIPTING
				ScriptableAIDirectControl::EVENT_MASK eventMask = ScriptableAIDirectControl::EVENT_MASK_OBJECT_TOUCH_LEFT;
				if (unit->isDirectControl()
					&& unit->getDirectControlType() == Unit::UNIT_DIRECT_CONTROL_TYPE_AI
					&& unit->getAIDirectControl() != NULL)
				{
					...
					if (strcmp(unit->getAIDirectControl()->getDirectControlName(), "scriptable") == 0)
					{
						...
						sp->error("DirectControlScripting::process - directControlClearObjectTouchLeftEventFlag, unit's \"directcontroltype\" is not \"scriptable\".");
					}
				} else {
					sp->error("DirectControlScripting::process - directControlClearObjectTouchLeftEventFlag, unit is not \"directcontrol\" type or not controlled by AI.");
				}
#endif
			} else {
				sp->error("DirectControlScripting::process - Attempt to directControlClearObjectTouchLeftEventFlag for null unit.");
			}
			break;

		case GS_CMD_directControlClearObjectTouchRightEventFlag:
			if (unit != NULL)
			{
#ifndef UNSAFE_DIRECT_CONTROL_SCRIPTING
				ScriptableAIDirectControl::EVENT_MASK eventMask = ScriptableAIDirectControl::EVENT_MASK_OBJECT_TOUCH_RIGHT;
				if (unit->isDirectControl()
					&& unit->getDirectControlType() == Unit::UNIT_DIRECT_CONTROL_TYPE_AI
					&& unit->getAIDirectControl() != NULL)
				{
					...
					if (strcmp(unit->getAIDirectControl()->getDirectControlName(), "scriptable") == 0)
					{
						...
						sp->error("DirectControlScripting::process - directControlClearObjectTouchRightEventFlag, unit's \"directcontroltype\" is not \"scriptable\".");
					}
				} else {
					sp->error("DirectControlScripting::process - directControlClearObjectTouchRightEventFlag, unit is not \"directcontrol\" type or not controlled by AI.");
				}
#endif
			} else {
				sp->error("DirectControlScripting::process - Attempt to directControlClearObjectTouchRightEventFlag for null unit.");
			}
			break;

		case GS_CMD_directControlClearStaticTouchLeftEventFlag:
			if (unit != NULL)
			{
#ifndef UNSAFE_DIRECT_CONTROL_SCRIPTING
				ScriptableAIDirectControl::EVENT_MASK eventMask = ScriptableAIDirectControl::EVENT_MASK_STATIC_TOUCH_LEFT;
				if (unit->isDirectControl()
					&& unit->getDirectControlType() == Unit::UNIT_DIRECT_CONTROL_TYPE_AI
					&& unit->getAIDirectControl() != NULL)
				{
					...
					if (strcmp(unit->getAIDirectControl()->getDirectControlName(), "scriptable") == 0)
					{
						...
						sp->error("DirectControlScripting::process - directControlClearStaticTouchLeftEventFlag, unit's \"directcontroltype\" is not \"scriptable\".");
					}
				} else {
					sp->error("DirectControlScripting::process - directControlClearStaticTouchLeftEventFlag, unit is not \"directcontrol\" type or not controlled by AI.");
				}
#endif
			} else {
				sp->error("DirectControlScripting::process - Attempt to directControlClearStaticTouchLeftEventFlag for null unit.");
			}
			break;

		case GS_CMD_directControlClearStaticTouchRightEventFlag:
			if (unit != NULL)
			{
#ifndef UNSAFE_DIRECT_CONTROL_SCRIPTING
				ScriptableAIDirectControl::EVENT_MASK eventMask = ScriptableAIDirectControl::EVENT_MASK_STATIC_TOUCH_RIGHT;
				if (unit->isDirectControl()
					&& unit->getDirectControlType() == Unit::UNIT_DIRECT_CONTROL_TYPE_AI
					&& unit->getAIDirectControl() != NULL)
				{
					...
					if (strcmp(unit->getAIDirectControl()->getDirectControlName(), "scriptable") == 0)
					{
						...
						sp->error("DirectControlScripting::process - directControlClearStaticTouchRightEventFlag, unit's \"directcontroltype\" is not \"scriptable\".");
					}
				} else {
					sp->error("DirectControlScripting::process - directControlClearStaticTouchRightEventFlag, unit is not \"directcontrol\" type or not controlled by AI.");
				}
#endif
			} else {
				sp->error("DirectControlScripting::process - Attempt to directControlClearStaticTouchRightEventFlag for null unit.");
			}
			break;

		case GS_CMD_directControlClearUnitTouchLeftEventFlag:
			if (unit != NULL)
			{
#ifndef UNSAFE_DIRECT_CONTROL_SCRIPTING
				ScriptableAIDirectControl::EVENT_MASK eventMask = ScriptableAIDirectControl::EVENT_MASK_UNIT_TOUCH_LEFT;
				if (unit->isDirectControl()
					&& unit->getDirectControlType() == Unit::UNIT_DIRECT_CONTROL_TYPE_AI
					&& unit->getAIDirectControl() != NULL)
				{
					...
					if (strcmp(unit->getAIDirectControl()->getDirectControlName(), "scriptable") == 0)
					{
						...
						sp->error("DirectControlScripting::process - directControlClearUnitTouchLeftEventFlag, unit's \"directcontroltype\" is not \"scriptable\".");
					}
				} else {
					sp->error("DirectControlScripting::process - directControlClearUnitTouchLeftEventFlag, unit is not \"directcontrol\" type or not controlled by AI.");
				}
#endif
			} else {
				sp->error("DirectControlScripting::process - Attempt to directControlClearUnitTouchLeftEventFlag for null unit.");
			}
			break;

		case GS_CMD_directControlClearUnitTouchRightEventFlag:
			if (unit != NULL)
			{
#ifndef UNSAFE_DIRECT_CONTROL_SCRIPTING
				ScriptableAIDirectControl::EVENT_MASK eventMask = ScriptableAIDirectControl::EVENT_MASK_UNIT_TOUCH_RIGHT;
				if (unit->isDirectControl()
					&& unit->getDirectControlType() == Unit::UNIT_DIRECT_CONTROL_TYPE_AI
					&& unit->getAIDirectControl() != NULL)
				{
