...
namespace game
{
                                         ...
                                         bool                *pause)
    {
        ...
        case GS_CMD_directControlOnByName:
            if (stringData != NULL) {
                if (unit != NULL) {
                    ...
                    sp->error(
                        "DirectControlScripting::process - directControl..., unit's \"directcontroltype\" is not \"scriptable\".");
                }
            } else {
                sp->error(
                    "DirectControlScripting::process - directControl..., unit is not \"directcontrol\" type or not controlled by AI.");
            }
        } else {
            sp->error(
                "DirectControlScripting::process - directControlOnByName parameter invalid (expected direct control name).");
        }
#endif
                } else {
        ...
        case GS_CMD_directControlOffByName:
            ...
            sp->error(
                "DirectControlScripting::process - directControlOffByName parameter invalid (expected direct control name).");
        }
#endif
                } else {
        ...
        case GS_CMD_directControlListenToEvent:
            if (stringData != NULL) {
                if (unit != NULL) {
#ifndef UNSAFE_DIRECT_CONTROL_SCRIPTING
                    ScriptableAIDirectControl::EVENT_MASK eventMask = ScriptableAIDirectControl::getEventMaskByName(
                        stringData);
                    ...
                    sp->error(
                        "DirectControlScripting::process - directControlListenToEvent, unit's \"directcontroltype\" is not \"scriptable\".");
                }
            } else {
                sp->error(
                    "DirectControlScripting::process - directControlListenToEvent, unit is not \"directcontrol\" type or not controlled by AI.");
            }
        } else {
            sp->error(
                "DirectControlScripting::process - directControlListenToEvent parameter invalid (expected direct control event name).");
        }
#endif
                } else {
        ...
        case GS_CMD_directControlDoNotListenToEvent:
            if (stringData != NULL) {
                if (unit != NULL) {
                    ...
                    sp->error(
                        "DirectControlScripting::process - directControlDoNotListenToEvent, unit's \"directcontroltype\" is not \"scriptable\".");
                }
            } else {
                sp->error(
                    "DirectControlScripting::process - directControlDoNotListenToEvent, unit is not \"directcontrol\" type or not controlled by AI.");
            }
        } else {
            sp->error(
                "DirectControlScripting::process - directControlDoNotListenToEvent parameter invalid (expected direct control event name).");
        }
#endif
                } else {
                    sp->error(
                        "DirectControlScripting::process - Attempt to directControlDoNotListenToEvent for null unit.");
                }
            } else {
                sp->error(
                    "DirectControlScripting::process - Attempt to directControlDoNotListenToEvent parameter missing.");
            }
            break;
        ...
        case GS_CMD_directControlAutomaticallyDisableAction:
            if (stringData != NULL) {
                if (unit != NULL) {
                    ...
                    sp->error(
                        "DirectControlScripting::process - directControlAutomaticallyDisableAction, unit's \"directcontroltype\" is not \"scriptable\".");
                }
            } else {
                sp->error(
                    "DirectControlScripting::process - directControlAutomaticallyDisableAction, unit is not \"directcontrol\" type or not controlled by AI.");
            }
        } else {
            sp->error(
                "DirectControlScripting::process - directControlAutomaticallyDisableAction parameter invalid (expected direct control name).");
        }
#endif
                } else {
                    sp->error(
                        "DirectControlScripting::process - Attempt to directControlAutomaticallyDisableAction for null unit.");
                }
            } else {
                sp->error(
                    "DirectControlScripting::process - directControlAutomaticallyDisableAction parameter missing.");
            }
            break;
        ...
        case GS_CMD_directControlDoNotAutomaticallyDisableAction:
            if (stringData != NULL) {
                if (unit != NULL) {
                    ...
                    sp->error(
                        "DirectControlScripting::process - directControlDoNotAutomaticallyDisableAction, unit's \"directcontroltype\" is not \"scriptable\".");
                }
            } else {
                sp->error(
                    "DirectControlScripting::process - directControlDoNotAutomaticallyDisableAction, unit is not \"directcontrol\" type or not controlled by AI.");
            }
        } else {
            sp->error(
                "DirectControlScripting::process - directControlDoNotAutomaticallyDisableAction parameter invalid (expected direct control name).");
        }
#endif
                } else {
                    sp->error(
                        "DirectControlScripting::process - Attempt to directControlDoNotAutomaticallyDisableAction for null unit.");
                }
            } else {
                sp->error(
                    "DirectControlScripting::process - directControlDoNotAutomaticallyDisableAction parameter missing.");
            }
            break;
        ...
        case GS_CMD_directControlSetTimerMsec:
            if (intData >= GAME_TICK_MSEC) {
                if (unit != NULL) {
                    ...
                    sp->error(
                        "DirectControlScripting::process - directControlSetTimerMsec, unit's \"directcontroltype\" is not \"scriptable\".");
                }
            } else {
                sp->error(
                    "DirectControlScripting::process - directControlSetTimerMsec, unit is not \"directcontrol\" type or not controlled by AI.");
            }
#endif
                } else {
                ...
                sp->error(
                    "DirectControlScripting::process - directControlSetTimerMsec parameter bad (value less than one tick in msec).");
            }
            break;
        ...
        case GS_CMD_directControlSetAimMode:
            if (stringData != NULL) {
                if (unit != NULL) {
#ifndef UNSAFE_DIRECT_CONTROL_SCRIPTING
                    ScriptableAIDirectControl::AIM_MODE aimMode = ScriptableAIDirectControl::getAimModeByName(
                        stringData);
                    ...
                    sp->error(
                        "DirectControlScripting::process - directControlSetAimMode, unit's \"directcontroltype\" is not \"scriptable\".");
                }
            } else {
                sp->error(
                    "DirectControlScripting::process - directControlSetAimMode, unit is not \"directcontrol\" type or not controlled by AI.");
            }
        } else {
            sp->error(
                "DirectControlScripting::process - directControlSetAimMode parameter bad (expected offset_self, absolute, unit_target or target_unified_handle).");
        }
#endif
                } else {
        ...
        case GS_CMD_directControlSetAimPositionIgnoringMode:
            if (unit != NULL) {
                ...
                sp->error(
                    "DirectControlScripting::process - directControlSetAimPositionIgnoringMode, unit's \"directcontroltype\" is not \"scriptable\".");
            }
        } else {
            sp->error(
                "DirectControlScripting::process - directControlSetAimPositionIgnoringMode, unit is not \"directcontrol\" type or not controlled by AI.");
        }
#endif
            } else {
                sp->error(
                    "DirectControlScripting::process - Attempt to directControlSetAimPositionIgnoringMode for null unit.");
            }
            break;
            ...
            if (unit != NULL) {
                ...
                if (sdc->getAimMode() == ScriptableAIDirectControl::AIM_MODE_OFFSET_SELF) {
                    ...
                    if ( unit->targeting.hasTarget() ) {
                        ...
                        sp->warning(
                            "DirectControlScripting::process - directControlSetAimToPositionByMode, unit aim mode is \"offset_unit_target\" but unit has no target.");
                    }
                ...
                sp->error(
                    "DirectControlScripting::process - directControlSetAimToPositionByMode, unit's \"directcontroltype\" is not \"scriptable\".");
            }
        } else {
            sp->error(
                "DirectControlScripting::process - directControlSetAimToPositionByMode, unit is not \"directcontrol\" type or not controlled by AI.");
        }
#endif
            } else {
                sp->error(
                    "DirectControlScripting::process - Attempt to directControlSetAimToPositionByMode for null unit.");
            }
            break;
