            ...
            if (ani != NULL) {
                if (stringData != NULL) {
                    ...
                    if (anim != -1) {
                        ...
                        sp->error(
                            "AnimationScripting::process - aniAnim parameter bad, anim with given name does not exist.");
                        sp->debug(stringData);
                    }
                } else {
            ...
            if (ani != NULL) {
                if (stringData != NULL) {
                    ...
                    if (anim != -1) {
                        ...
                        sp->error(
                            "AnimationScripting::process - aniEndAnim parameter bad, anim with given name does not exist.");
                        sp->debug(stringData);
                    }
                } else {
            ...
            if (ani != NULL) {
                if (stringData != NULL) {
                    ...
                    if (anim != -1) {
                        ...
                        sp->error(
                            "AnimationScripting::process - aniBlend parameter bad, anim with given name does not exist.");
                        sp->debug(stringData);
                    }
                } else {
            ...
            if (stringData != NULL) {
                ...
                if (pt == NULL) {
                    ...
                    if ( pt->isInherited( getPartTypeById( PARTTYPE_ID_STRING_TO_INT("Weap") ) ) ) {
                        ...
                        sp->error(
                            "AnimationScripting::process - aniFireProjectile, attempt to use non-weapon part type.");
                    }
                }
            } else {
