...
namespace game
{
                                            ...
                                            IStorm3D_Terrain *terrain, ui::LightManager *lightManager)
    {
        ...
        if (terrain != NULL) {
            ...
            r.enableFeature( IStorm3D_TerrainRenderer::BetterGlowSampling,
                             SimpleOptions::getBool(DH_OPT_B_BETTER_GLOW_SAMPLING) );
            ...
            r.enableFeature( IStorm3D_TerrainRenderer::TerrainObjectRendering,
                             SimpleOptions::getBool(DH_OPT_B_RENDER_TERRAINOBJECTS) );
            r.enableFeature( IStorm3D_TerrainRenderer::HeightmapRendering,
                             SimpleOptions::getBool(DH_OPT_B_RENDER_HEIGHTMAP) );
            r.enableFeature( IStorm3D_TerrainRenderer::FreezeCameraCulling,
                             SimpleOptions::getBool(DH_OPT_B_FREEZE_CAMERA_CULLING) );
            r.enableFeature( IStorm3D_TerrainRenderer::FreezeSpotCulling,
                             SimpleOptions::getBool(DH_OPT_B_FREEZE_SPOT_CULLING) );
            ...
            r.enableFeature( IStorm3D_TerrainRenderer::LightmapFiltering,
                             SimpleOptions::getBool(DH_OPT_B_LIGHTMAP_FILTERING) );
            r.enableFeature( IStorm3D_TerrainRenderer::BlackAndWhite,
                             SimpleOptions::getBool(DH_OPT_B_RENDER_BLACK_AND_WHITE) );

            r.enableFeature( IStorm3D_TerrainRenderer::RenderDecals, SimpleOptions::getBool(DH_OPT_B_RENDER_DECALS) );
            r.enableFeature( IStorm3D_TerrainRenderer::RenderSpotDebug,
                             SimpleOptions::getBool(DH_OPT_B_RENDER_SPOT_DEBUG) );
            r.enableFeature( IStorm3D_TerrainRenderer::RenderFakeShadowDebug,
                             SimpleOptions::getBool(DH_OPT_B_RENDER_FAKESHADOW_DEBUG) );
            r.enableFeature( IStorm3D_TerrainRenderer::RenderGlowDebug,
                             SimpleOptions::getBool(DH_OPT_B_RENDER_GLOW_DEBUG) );
            ...
            r.enableFeature( IStorm3D_TerrainRenderer::ParticleReflection,
                             SimpleOptions::getBool(DH_OPT_B_RENDER_PARTICLE_REFLECTION) );
            r.enableFeature( IStorm3D_TerrainRenderer::TerrainTextures,
                             SimpleOptions::getBool(DH_OPT_B_RENDER_TERRAIN_TEXTURES) );
            r.enableFeature( IStorm3D_TerrainRenderer::SmoothShadows,
                             SimpleOptions::getBool(DH_OPT_B_RENDER_SMOOTHED_SHADOWS) );
            r.enableFeature( IStorm3D_TerrainRenderer::ProceduralFallback,
                             SimpleOptions::getBool(DH_OPT_B_PROCEDURAL_FALLBACK) );

            r.enableFeature( IStorm3D_TerrainRenderer::HalfRendering,
                             SimpleOptions::getBool(DH_OPT_B_RENDER_HALF_RESOLUTION) );
            ...
            r.enableFeature( IStorm3D_TerrainRenderer::AdditionalAlphaTestPass,
                             SimpleOptions::getBool(DH_OPT_B_RENDER_SKY_BLOOM) );
#endif
        }
    ...
    void OptionApplier::applyOptions(Game *game, GameOptionManager *oman, Ogui *ogui)
    {
        ...
        if (game->gameUI->getTerrain() != NULL) {
            ...
            applyDisplayOptions( game->gameUI->getStorm3D(),
                                 game->getGameScene()->getStormScene(), terrain, game->gameUI->getLightManager() );
        } else {
        ...
        {
            game->getGamePhysics()->getPhysicsLib()->enableFeature(
                 frozenbyte::physics::PhysicsLib::VISUALIZE_COLLISION_SHAPES,
                SimpleOptions::getBool(DH_OPT_B_PHYSICS_VISUALIZE_COLLISION_SHAPES) );
            game->getGamePhysics()->getPhysicsLib()->enableFeature(
                 frozenbyte::physics::PhysicsLib::VISUALIZE_DYNAMIC,
                SimpleOptions::getBool(DH_OPT_B_PHYSICS_VISUALIZE_DYNAMIC) );
            game->getGamePhysics()->getPhysicsLib()->enableFeature(
                 frozenbyte::physics::PhysicsLib::VISUALIZE_STATIC,
                SimpleOptions::getBool(DH_OPT_B_PHYSICS_VISUALIZE_STATIC) );
            game->getGamePhysics()->getPhysicsLib()->enableFeature(
                 frozenbyte::physics::PhysicsLib::VISUALIZE_COLLISION_CONTACTS,
                SimpleOptions::getBool(DH_OPT_B_PHYSICS_VISUALIZE_COLLISION_CONTACTS) );
            game->getGamePhysics()->getPhysicsLib()->enableFeature(
                 frozenbyte::physics::PhysicsLib::VISUALIZE_FLUIDS,
                SimpleOptions::getBool(DH_OPT_B_PHYSICS_VISUALIZE_FLUIDS) );
            game->getGamePhysics()->getPhysicsLib()->enableFeature(
                 frozenbyte::physics::PhysicsLib::VISUALIZE_CCD, SimpleOptions::getBool(DH_OPT_B_PHYSICS_VISUALIZE_CCD) );
        }
        ...
        if ( game && game->getGameUI() && game->getGameUI()->getVisualEffectManager() &&
            ...
            game->getGameUI()->getVisualEffectManager()->getParticleEffectManager()->setModelParticleParameters(
                maxParticles,
                maxSpawnParticles);
#endif
